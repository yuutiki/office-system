        ...
        <div class="mx-4 sm:p-8">
            <form id="corporationForm" method="post" action="{{route('clientcorporation.store')}}" enctype="multipart/form-data">
                ...
                <div class="w-full flex flex-col">
                    ...
                    <textarea name="memo" class="w-auto py-1 border border-gray-300 rounded-md mt-1 placeholder-gray-400" id="memo" cols="30" rows="5" placeholder="法人に関するメモ...">{{old('memo')}}</textarea>
                </div>
                @error('memo')
                    <div class="text-red-500">{{$message}}</div>
                @enderror
