        ...
        <form id="corporationForm" method="post" action="{{route('clientcorporation.store')}}" enctype="multipart/form-data">
            ...
            {{-- <div class="md:flex items-center mt-8">
                <div class="w-full flex flex-col">
                    <label for="clientcorporation_num" class="font-semibold dark:text-gray-100 text-gray-900 leading-none mt-4">法人ID</label>
                    <input type="text" name="clientcorporation_num" class="w-auto py-1 placeholder-gray-400 border border-gray-300 rounded-sm mt-1" id="clientcorporation_num" value="{{old('clientcorporation_num')}}" placeholder="例）0001">
                </div>
            </div> --}}

            <div class="w-full flex flex-col">
                <label for="clientcorporation_name" class="font-semibold dark:text-gray-100 text-gray-900 leading-none mt-4">法人正式名称</label>
                <input type="text" name="clientcorporation_name" class="w-auto py-1 placeholder-gray-400 border border-gray-300 rounded-sm mt-1" id="clientcorporation_name" value="{{old('clientcorporation_name')}}" placeholder="学校法人 烏丸学園">
            </div>
            ...
            <div class="w-full flex flex-col">
                ...
                <input type="text" name="clientcorporation_abbreviation_name" class="w-auto py-1 placeholder-gray-400 border border-gray-300 rounded-sm mt-1" id="clientcorporation_abbreviation_name" value="{{old('clientcorporation_abbreviation_name')}}" placeholder="烏丸学園">
            </div>
            ...
            <div class="w-full flex flex-col">
                ...
                <input type="text" name="clientcorporation_kana_name" class="w-auto py-1 placeholder-gray-400 border border-gray-300 rounded-sm mt-1" id="clientcorporation_kana_name" value="{{old('clientcorporation_kana_name')}}" placeholder="ガッコウホウジン カラスマガクエン">
            </div>
...
{{-- カラム追加と改行を表現できるようにする --}}
            <div class="w-full flex flex-col">
                ...
                <textarea name="memo" class="w-auto py-1 border border-gray-300 rounded-sm mt-1 placeholder-gray-400" id="memo" value="{{old('memo')}}" cols="30" rows="5" placeholder="法人に関するメモ..."></textarea>
            </div>
            @error('memo')
                <div class="text-red-500">{{$message}}</div>
            @enderror
