            ...
            @foreach ($clientcorporations as $clientcorporation)
                <tbody>
                    <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-600 dark:text-white">
                        ...
                        {{-- <td class="px-6 py-4">
                            {{$clientcorporation->client_corporate_kana}}
                        </td> --}}
                        {{-- <td class="px-4 py-4">
                            {{$keepdata->keepdate}}
                        </td>
                        ...
                        <td class="px-4 py-4 text-center">
                            <a href="{{route('clientcorporation.create',$clientcorporation)}}" class="font-medium text-blue-600 dark:text-blue-500 hover:underline">編集</a>
                        </td>
                        <td class="px-4 py-4 text-center">
                            <a href="{{route('client.create',$clientcorporation)}}" class="font-medium text-blue-600 dark:text-blue-500 hover:underline">顧客追加</a>
                        </td>
                    </tr>
                </tbody>
            @endforeach
