        ...
        <div class="mx-4 sm:p-8">
            <form method="post" action="{{route('clientcorporation.update',$clientcorporation)}}" enctype="multipart/form-data">
                ...
                <div class="w-full flex flex-col">
                    ...
                    <input type="text" name="clientcorporation_abbreviation_name" class="w-auto py-1 placeholder-gray-400 border border-gray-300 rounded-md mt-1" id="clientcorporation_abbreviation_name" value="{{old('clientcorporation_abbreviation_name',$clientcorporation->clientcorporation_abbreviation_name)}}" placeholder="烏丸学園">
                </div>
