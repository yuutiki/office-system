<button {{ $attributes->merge([
    'type' => 'submit',
    'class' => 'flex items-center pl-2 sm:px-4 py-1.5 text-sm font-medium text-white rounded bg-indigo-700 hover:bg-indigo-800 focus:ring-2 focus:ring-indigo-300 dark:bg-indigo-600 dark:hover:bg-indigo-700 focus:outline-none dark:focus:ring-indigo-800'
])}} >
