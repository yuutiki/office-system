    ...
    <div class="max-h-full w-full max-w-7xl overflow-y-auto">
        <div class="relative p-4 bg-white rounded shadow dark:bg-gray-700">
            ...
            <div class="flex items-center justify-between px-2 pb-2 border-b rounded-t dark:border-gray-600">
                ...
                <button type="button" onclick="CorporationSearchModal.hide('{{ $modalId }}')" class="text-gray-400 bg-transparent hover:bg-gray-200 hover:text-gray-900 rounded text-sm w-8 h-8 ml-auto inline-flex justify-center items-center dark:hover:bg-gray-600 dark:hover:text-white">
            ...
            <div class="grid gap-x-2 mb-4 grid-cols-1 sm:grid-cols-3">
                ...
                <div class="w-full flex flex-col pr-2">
                    <label for="corporationNumber" class="dark:text-gray-100 text-gray-900 leading-none mt-4">営業担当</label>
                    <div id="{{ $modalId }}_user_dropdown" class="relative w-full mt-1">
                        ...
                        <div id="{{ $modalId }}_user_dropdown_menu" class="absolute z-10 w-full mt-1 bg-white border border-gray-300 dark:border-gray-600 rounded-md shadow-lg hidden">
                            <div class="p-2">
                                <input 
            ...
            <div class="flex gap-2">
                <button type="button" 
                        onclick="CorporationSearchModal.search('{{ $modalId }}', '{{ $screenId }}')" 
                ...
                <button type="button" 
                        onclick="CorporationSearchModal.clearSearch('{{ $modalId }}')"
