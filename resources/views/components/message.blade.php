@if(session('success'))
    <div id="flash-message-success" class="fixed top-16 left-0 flex items-center justify-center w-screen z-50 pointer-events-none">
...
@if(session('error'))
    <div id="flash-message-error" class="fixed top-16 left-0 flex items-center justify-center w-screen z-50 pointer-events-none">
