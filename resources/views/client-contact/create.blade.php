            ...
            <div class="ml-auto flex justify-end items-center space-x-2">
                <form method="post" action="{{ route('client-contacts.store') }}" enctype="multipart/form-data" id="clientContactForm" class="flex items-center">
                    ...
                    @can('storeUpdate_corporations')
                        <x-buttons.save-button form-id="clientContactForm" id="saveButton" onkeydown="stopTab(event)">
                            {{ __('save') }}
    ...
    <div class="max-w-7xl mx-auto px-2 md:pl-14">
        ...
        <div class="hidden md:p-4 p-2 mb-4 rounded bg-gray-50 dark:bg-gray-800" id="base" role="tabpanel" aria-labelledby="base-tab">
            ...
            <div class="grid gap-4 md:grid-cols-3">
                <div class="flex md:mt-4 mt-4">
                    <div class="w-full flex flex-col">
                        ...
                        <input type="text" form="clientContactForm" name="client_num" id="client_num" value="{{ old('client_num') }}" class="input-readonly pointer-events-none" placeholder="" readonly>
                    </div>
                    <div class="hidden">
                        <label for="client_id">顧客ID</label>
                        <input type="text" form="clientContactForm" name="client_id" id="client_id" value="{{ old('client_id') }}">
                    </div>
                    <!-- 顧客検索ボタン(画面中～) -->
                ...
                <div class="w-full flex flex-col md:mt-4">
                    ...
                    <input type="text" form="clientContactForm" name="client_name" id="client_name" value="{{ old('client_name') }}" class="input-readonly pointer-events-none" placeholder="" readonly>
                </div>
                <div class="w-full flex flex-col md:mt-4">
                    ...
                    <input type="text" form="clientContactForm" name="affiliation2_id" id="affiliation2_id" value="{{ old('affiliation2_id') }}" class="input-readonly pointer-events-none" placeholder="" readonly>
                </div>
                @error('client_num')
            ...
            <label class="relative inline-flex items-center cursor-pointer">
                <input type="checkbox" form="clientContactForm" name="is_retired" id="is_retired" value="1" @checked(old('is_retired') == 1) class="sr-only peer">
            ...
            <div class="grid gap-4 sm:grid-cols-2 md:mx-4">
                <div>
                    <div class="w-full flex flex-col">
                        ...
                        <input type="text" form="clientContactForm" name="last_name" id="last_name" value="{{ old('last_name') }}" class="input-secondary" placeholder="">
                    </div>
                    @error('last_name')
                        <div class="text-red-500">{{$message}}</div>
                    @enderror
                ...
                <div>
                    <div class="w-full flex flex-col">
                        ...
                        <input type="text" form="clientContactForm" name="first_name" id="first_name" value="{{ old('first_name') }}" class="input-secondary" placeholder="">
                    </div>
                    @error('first_name')
                        <div class="text-red-500">{{$message}}</div>
                    @enderror
                ...
                <div>
                    <div class="w-full flex flex-col">
                        ...
                        <input type="text" form="clientContactForm" name="last_name_kana" id="last_name_kana" value="{{ old('last_name_kana') }}" class="input-secondary" placeholder="">
                    </div>
                ...
                <div>
                    <div class="w-full flex flex-col">
                        ...
                        <input type="text" form="clientContactForm" name="first_name_kana" id="first_name_kana" value="{{ old('first_name_kana') }}" class="input-secondary" placeholder="">
                    </div>
                ...
                <div>
                    <div class="w-full flex flex-col">
                        ...
                        <input type="text" form="clientContactForm" name="division_name" id="division_name" value="{{ old('division_name') }}" class="input-secondary" placeholder="">
                    </div>
                    @error('division_name')
                        <div class="text-red-500">{{$message}}</div>
                    @enderror
                ...
                <div>
                    <div class="w-full flex flex-col">
                        ...
                        <input type="text" form="clientContactForm" name="position_name" id="position_name" value="{{ old('position_name') }}" class="input-secondary" placeholder="">
                    </div>
                    @error('position_name')
                        <div class="text-red-500">{{$message}}</div>
                    @enderror
            ...
            <div class="grid gap-4 sm:grid-cols-2 md:mx-4">
                <div>
                    <div class="w-full flex flex-col">
                        ...
                        <input type="text" form="clientContactForm" name="tel1" id="tel1" onchange="validateAndFormat('tel1')" value="{{ old('tel1') }}" class="input-secondary" placeholder="090-1234-5678">
                    </div>
                    @error('tel1')
                        <div class="text-red-500">{{$message}}</div>
                    @enderror
                ...
                {{-- <div class="w-full flex flex-col">
                    ...
                    <input type="text" form="clientContactForm" name="tel2" id="tel2" value="{{ old('tel2') }}" class="input-secondary" placeholder="090-1234-5678">
                </div>
                @error('tel2')
                    <div class="text-red-500">{{$message}}</div>
                @enderror --}}
                <div>
                    <div class="w-full flex flex-col">
                        ...
                        <input type="text" form="clientContactForm" name="fax1" id="fax1" onchange="validateAndFormat('fax1')" value="{{ old('fax1') }}" class="input-secondary" placeholder="090-1234-5678">
                    </div>
                    @error('fax1')
                        <div class="text-red-500">{{$message}}</div>
                    @enderror
                ...
                {{-- <div class="w-full flex flex-col">
                    ...
                    <input type="text" form="clientContactForm" name="fax2" id="fax2" value="{{ old('fax2') }}" class="input-secondary" placeholder="090-1234-5678">
                </div>
                @error('fax2')
                    <div class="text-red-500">{{$message}}</div>
                @enderror --}}
                {{-- <div class="w-full flex flex-col">
                    ...
                    <input type="text" form="clientContactForm" name="int_tel" id="int_tel" value="{{ old('int_tel') }}" class="input-secondary" placeholder="090-1234-5678">
                </div>
                @error('int_tel')
                    <div class="text-red-500">{{$message}}</div>
                @enderror --}}
                <div>
                    <div class="w-full flex flex-col">
                        ...
                        <input type="text" form="clientContactForm" name="phone" id="phone" onchange="validateAndFormat('phone')" value="{{ old('phone') }}" class="input-secondary" placeholder="090-1234-5678">
                    </div>
                    @error('phone')
                        <div class="text-red-500">{{$message}}</div>
                    @enderror
                ...
                <div>
                    <div class="w-full flex flex-col">
                        ...
                        <input type="text" form="clientContactForm" name="mail" id="mail" value="{{ old('mail') }}" class="input-secondary" placeholder="test@hoge.com">
                    </div>
                    @error('mail')
                        <div class="text-red-500">{{$message}}</div>
                    @enderror
            ...
            <div class="grid gap-4 mb-4 lg:grid-cols-5 md:mx-4">
                <div class="col-span-1">
                    <div class="flex">
                        <div class="w-full flex flex-col">
                            ...
                            <input type="text" form="clientContactForm" name="post_code" class="input-primary" id="post_code" value="{{ old('post_code') }}" placeholder="">
                        </div>
                ...
                <div class="w-full flex flex-col md:col-span-3">
                    <div class="w-full flex flex-col">
                        ...
                        <input type="text" form="clientContactForm" name="address_1" id="address_1" value="{{ old('address_1') }}" class="input-secondary" placeholder="">
                    </div>
                    @error('address_1')
                        <div class="text-red-500">{{$message}}</div>
                    @enderror
            ...
            <div>
                <div class="flex flex-col md:mx-4">
                    ...
                    <textarea form="clientContactForm" name="client_contact_memo" id="client_contact_memo" value="" class="input-secondary" cols="30" rows="5" data-auto-resize="true" placeholder="">{{ old('client_contact_memo') }}</textarea>
                </div>           
                ...
                <ul class="mt-4 mb-4 items-center w-full text-sm font-medium text-gray-900 bg-white border border-gray-200 rounded-lg md:flex dark:bg-gray-700 dark:border-gray-600 dark:text-white">
                    <li class="w-full border-b border-gray-200 md:border-b-0 md:border-r dark:border-gray-600">
                        <div class="flex items-center pl-3">
                            <input id="is_billing_receiver" form="clientContactForm" name="is_billing_receiver" type="checkbox" value="1" {{ old('is_billing_receiver') ? 'checked' : '' }} class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 rounded focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-700 dark:focus:ring-offset-gray-700 focus:ring-2 dark:bg-gray-600 dark:border-gray-500">
                    ...
                    <li class="w-full border-gray-200 md:border-b-0 dark:border-gray-600">
                        <div class="flex items-center pl-3">
                            <input id="is_payment_receiver" form="clientContactForm" name="is_payment_receiver" type="checkbox" value="1" {{ old('is_payment_receiver') ? 'checked' : '' }} class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 rounded focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-700 dark:focus:ring-offset-gray-700 focus:ring-2 dark:bg-gray-600 dark:border-gray-500">
                ...
                <ul class="mt-4 mb-4 items-center w-full text-sm font-medium text-gray-900 bg-white border border-gray-200 rounded-lg dark:bg-gray-700 dark:border-gray-600 dark:text-white">
                    @foreach($checkboxOptions as $option)
                        <li class="w-full @if($loop->last) border-0 @else border-b border-gray-200 dark:border-gray-600 @endif">
                            <div class="flex items-center pl-3">
                                <input id="{{ $option->name }}" form="clientContactForm" name="{{ $option->name }}" type="checkbox" value="1" 
