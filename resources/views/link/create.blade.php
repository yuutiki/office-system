                ...
                <div class="mt-2 p-4 sm:p-4 bg-white dark:bg-gray-800 shadow sm:rounded-lg">
                    ...
                    <div class="grid gap-4 mb-4 md:grid-cols-2 ">
                        <div class="w-full flex flex-col">
                            ...
                            <select name="department_id" class=" w-auto py-1 placeholder-gray-500 border border-gray-300 rounded-md mt-1" id="department_id" value="{{old('department_id')}}" required>
