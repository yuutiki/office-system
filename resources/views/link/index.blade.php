        ...
        <div id="accordion-color-body-1" class="hidden" aria-labelledby="accordion-color-heading-1">
            <div class="w-5/6 border border-t-0 mx-auto h-auto dark:text-white rounded-b-md border-gray-400 bg-white dark:bg-gray-400 shadow-md">
                <form method="GET" action="{{ route('link.index') }}" id="linkform">
                    ...
                    <div class="md:flex flex-wrap">
                        <div class="relative w-auto ml-2 mt-2">
                            ...
                            <input type="search" name="employee_num" value="@if (isset($employee_num)){{$employee_num}}@endif" oninput="value = value.replace(/[^0-9]+/i,'');" class=" block w-full py-1.5 pl-10 text-sm text-gray-900 border border-gray-300 rounded bg-gray-50 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="社員番号" >
                        </div>
                        ...
                        <div class="relative w-auto ml-2 mt-2">
                            ...
                            <input type="search" name="link_name" value="@if (isset($link_name)){{$link_name}}@endif" class="block w-full py-1.5 pl-10 text-sm text-gray-900 border border-gray-300 rounded bg-gray-50 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="氏名" >    
                        </div>
                        <div class="flex-nowrap">
                            <select  name="department" class="mt-2 w-auto ml-2 py-1.5 text-sm rounded bg-gray-50 border border-gray-300 text-gray-900 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                ...
                <div class="w-5/6 mt-2 mb-2 ml-8 flex justify-start">
                    <button type="submit" form="linkform" class="w-20 px-6 py-1.5 font-medium text-sm rounded text-white focus:outline-none focus:ring-4 focus:ring-blue-300 bg-blue-700 hover:bg-blue-800 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">検索</button>
                    <button type="button" value="reset" form="linkform" id="clear" class="w-20 ml-2 px-4 py-1.5 font-medium text-sm rounded text-white focus:outline-none focus:ring-4 focus:ring-blue-300 bg-red-700 hover:bg-red-800 dark:bg-red-600 dark:hover:bg-red-700 dark:focus:ring-blue-800">リセット</button>
                </div>
            </div>
        </div>
    </div> --}}
