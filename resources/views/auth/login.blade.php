<x-guest-layout>
    ...
    <div class="">
        <form method="POST" action="{{ route('login') }}">
            ...
            <x-primary-button class="mt-12 w-full items-center justify-center">
                <div class="py-0.5">{{ __('Log in') }}</div>
            </x-primary-button>    

            <div class="flex items-center mt-4 mb-4 justify-center">
                @if (Route::has('password.request'))
                    <a class="underline text-sm justify-center text-gray-600 dark:text-gray-400 hover:text-gray-900 dark:hover:text-gray-100 rounded-md focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500 dark:focus:ring-offset-gray-800" href="{{ route('password.request') }}">
