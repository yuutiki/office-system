                    ...
                    <div class="hidden p-4 rounded-lg bg-gray-50 dark:bg-gray-800" id="profile" role="tabpanel" aria-labelledby="profile-tab">
                        <div class="grid gap-4 mb-4 sm:grid-cols-5 mt-2">
                            <div class="">
                                ...
                                <input type="text" name="head_post_code" class="w-full py-1 placeholder-gray-400 border border-gray-300 rounded-md mt-1" id="head_post_code" value="{{old('head_post_code')}}" placeholder="" onKeyUp="AjaxZip3.zip2addr(this,'','head_prefecture','head_addre1','','',false);">
                            </div>
                            <div class="">
                            ...
                            <div class="col-span-3">
                                ...
                                <input type="text" name="head_addre1" id="head_addre1" value="{{old('head_addre1')}}" class="w-full py-1 mt-1 placeholder-gray-400 border border-gray-300 rounded-md" placeholder="">
                            </div>
                            <div class="">
                                <label for="head_tel" class="font-semibold dark:text-gray-100 text-gray-900 leading-none mt-4">代表TEL（-）</label>
                                <input type="text" name="head_tel" pattern="\d{2,4}-?\d{2,4}-?\d{3,4}" maxlength="13" id="head_tel" value="{{old('head_tel')}}" class="w-full py-1 mt-1 placeholder-gray-400 border border-gray-300 rounded-md" placeholder="">
                            </div>
        
                            <div class="">
                                <label for="head_fax" class="font-semibold dark:text-gray-100 text-gray-900 leading-none mt-4">代表FAX（-）</label>
                                <input type="tel" name="head_fax" pattern="\d{2,4}-?\d{2,4}-?\d{3,4}" maxlength="13" id="head_fax" value="{{old('head_fax')}}" class="w-full py-1 mt-1 placeholder-gray-400 border border-gray-300 rounded-md"  placeholder="">
                            </div>
                        </div>
                        ...
                        <div class="grid gap-4 mb-1 sm:grid-cols-5 mt-1">
                            <div class="w-full flex flex-col">
                                ...
                                <input type="number" min="0" name="students" class="w-full py-1 placeholder-gray-400 border border-gray-300 rounded-md mt-1" id="students" value="{{old('students')}}">
                            </div>
                        </div>
                        <div class="grid gap-4 mb-1 sm:grid-cols-5 mt-1">
                            <div class="w-full flex flex-col">
                        ...
                        <div class="grid gap-4 mt-1 mb-4 sm:grid-cols-5">
                            ...
                            <div class="w-full flex flex-col hidden">
                                ...
                                <input form="updateForm" type="text" name="distribution_id" class="w-auto py-1 border border-gray-300 rounded-md mt-1 mb-2" id="distribution_id" value="{{old('distribution_id')}}" placeholder="">
                            </div>
                            <div class="w-full flex flex-col">
                                <label for="distribution_num" class="font-semibold dark:text-gray-100 text-gray-900 leading-none mt-1">ディーラ（法人）№</label>
                                <input type="text" name="distribution_num" class="dark:bg-gray-400 w-auto py-1 border border-gray-300 rounded-md mt-1" id="distribution_num" value="{{old('distribution_num')}}" disabled>
                            </div>
                            <div class="w-full flex flex-col col-span-3">
                                ...
                                <input type="text" name="distribution_name" class="dark:bg-gray-400 w-auto py-1 border border-gray-300 rounded-md mt-1 mb-2" id="distribution_name" value="{{old('distribution_name')}}" disabled>
                            </div>
                        </div>
    
                        <div class="w-full flex flex-col">
                            <label for="memo" class="font-semibold dark:text-gray-100 text-gray-900 leading-none mt-4">備考</label>
                            <textarea name="memo" class="w-auto py-1 border border-gray-300 rounded-md mt-1 placeholder-gray-400" id="auto-resize-textarea-client_memo" value="{{old('memo')}}" cols="30" rows="5">{{old('memo')}}</textarea>
                        </div>
            ...
            <div class="max-h-full w-full max-w-2xl">
                ...
                <div class="relative p-4 bg-white rounded-lg shadow dark:bg-gray-700">
                    ...
                    <div class="flex items-center justify-between p-5 border-b rounded-t dark:border-gray-600">
                        ...
                        <button type="button" onclick="hideDistributionModal()" class="text-gray-400 bg-transparent hover:bg-gray-200 hover:text-gray-900 rounded-lg text-sm w-8 h-8 ml-auto inline-flex justify-center items-center dark:hover:bg-gray-600 dark:hover:text-white">
                            <svg class="w-3 h-3" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 14 14">
                                <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="m1 1 6 6m0 0 6 6M7 7l6-6M7 7l-6 6"/>
                            </svg>
                            <span class="sr-only">Close modal</span>
                    ...
                    <form action="{{ route('clientcorporation.search') }}" method="GET">
                        ...
                        {{-- <div class="flex flex-wrap justify-start mx-5"> --}}
                            <div class="">
                                ...
                                <input type="text" name="distributionName" id="distributionName" class="block w-full mt-1 mr-2 py-1 placeholder-gray-400 border border-gray-300 rounded-md">
                            </div>
                            <div class="">
                                <label for="distributionNumber" class="block font-semibold dark:text-gray-100 text-gray-900 leading-none">法人番号</label>
                                <input type="text" name="distributionNumber" id="distributionNumber" class="block w-full mt-1 mr-2 py-1 placeholder-gray-400 border border-gray-300 rounded-md">
                            </div>
                        </div>
                    </form>
                    <div class=" max-h-80 overflow-y-auto overflow-x-hidden mt-4">
                    ...
                    <!-- Modal footer -->
                    <div class="flex items-center p-6 space-x-2 border-t border-gray-200 rounded-b dark:border-gray-600">
                        <button type="button" onclick="searchDistribution()" class="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">
                            検索
                        </button>
                        <button type="button" onclick="hideDistributionModal()" class="text-gray-500 bg-white hover:bg-gray-100 focus:ring-4 focus:outline-none focus:ring-gray-200 rounded-lg border border-gray-200 text-sm font-medium px-5 py-2.5 hover:text-gray-900 focus:z-10 dark:bg-gray-700 dark:text-gray-300 dark:border-gray-500 dark:hover:text-white dark:hover:bg-gray-600 dark:focus:ring-gray-600">
                            閉じる
                        </button> 
                    </div>
                </div>
