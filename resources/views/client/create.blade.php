<x-app-layout>
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="mx-4 sm:p-8">
            ...
            <form id="form1" method="post" action="{{route('client.store')}}" enctype="multipart/form-data" autocomplete="new-password">
                @csrf
                <!-- 法人検索ボタン -->
                <button type="button"  onclick="showModal()" class="md:ml-1 md:mt-1 mt-1 mb-2 w-full md:w-auto whitespace-nowrap text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-e rounded-s text-sm px-4 py-3 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">
                    法人検索
                </button>
                <div class="grid gap-4 mb-4 sm:grid-cols-2">
                    <div class="">
                        ...
                        <input type="text" name="clientcorporation_num" class="w-full py-1 placeholder-gray-400 border border-gray-300 rounded-e rounded-s mt-1 cursor-not-allowed" id="clientcorporation_num" value="{{old('clientcorporation_num')}}" placeholder="法人検索してください" readonly>
                    ...
                    <div class="">
                        ...
                        <input type="text" name="clientcorporation_name" class="w-full py-1 placeholder-gray-400 border border-gray-300 rounded-e rounded-s mt-1 cursor-not-allowed" id="clientcorporation_name" value="{{old('clientcorporation_name')}}" placeholder="法人検索してください" readonly>
                    ...
                    <div class="">
                        ...
                        <input type="text" name="client_name" class="w-full py-1 placeholder-gray-400 border border-gray-300 rounded-e rounded-s mt-1" id="client_name" value="{{old('client_name')}}" placeholder="例）烏丸大学">
                        @error('client_name')
                            <div class="text-red-500">{{ $message }}</div>
                        @enderror
                    </div>
                    <div class="">
                        ...
                        <input type="text" name="client_kana_name" class="w-full py-1 placeholder-gray-400 border border-gray-300 rounded-e rounded-s mt-1" id="client_kana_name" value="{{old('client_kana_name')}}" placeholder="例）カラスマダイガク">
                ...
                <div class="grid gap-4 mb-4 md:grid-cols-5 grid-cols-2">
                    <div>
                        ...
                        <select id="installation_type_id" name="installation_type_id" class="bg-gray-50 border border-gray-300 text-gray-900 rounded-e rounded-s focus:ring-blue-500 focus:border-blue-500 block w-full p-1.5 text-sm  dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                    ...
                    <div>
                        ...
                        <select id="client_type_id" name="client_type_id" class="bg-gray-50 border border-gray-300 text-gray-900 rounded-e rounded-s focus:ring-blue-500 focus:border-blue-500 block w-full p-1.5 text-sm  dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                            <option value="">未選択</option>
                    ...
                    <div>
                        ...
                        <select id="trade_status_id" name="trade_status_id" class="bg-gray-50 border border-gray-300 text-gray-900 rounded-e rounded-s focus:ring-blue-500 focus:border-blue-500 block w-full p-1.5 text-sm  dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                            <option value="">未選択</option>
                    ...
                    <div>
                        ...
                        <select id="user_id" name="user_id" class="bg-gray-50 border border-gray-300 text-gray-900 rounded-e rounded-s focus:ring-blue-500 focus:border-blue-500 block w-full p-1.5 text-sm  dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                            <option value="">未選択</option>
                ...
                <div id="myTabContent">
                    <div class="hidden p-4 rounded-e rounded-s bg-gray-50 dark:bg-gray-800" id="profile" role="tabpanel" aria-labelledby="profile-tab">
                        <div class="grid gap-4 mb-4 sm:grid-cols-5 mt-2">
                            <div class="">
                                ...
                                {{-- <input type="text" name="head_post_code" class="w-full py-1 placeholder-gray-400 border border-gray-300 rounded-e rounded-s mt-1" id="head_post_code" value="{{old('head_post_code')}}" placeholder="" onKeyUp="AjaxZip3.zip2addr(this,'','head_prefecture','head_addre1','','',false);"> --}}
                                <div class="relative w-full">
                                    <input type="text" name="head_post_code" class="w-full py-1 placeholder-gray-400 border border-gray-300 rounded-e rounded-s mt-1" id="head_post_code" value="{{old('head_post_code')}}" placeholder="">
                            ...
                            <div class="">
                                ...
                                <select id="head_prefecture" name="head_prefecture" class="w-full py-1.5  text-sm mt-1 bg-gray-50 border border-gray-300 text-gray-900 rounded-e rounded-s focus:ring-blue-500 focus:border-blue-500 dark:bg-white dark:border-gray-600 dark:placeholder-gray-400 dark:text-black dark:focus:ring-blue-500 dark:focus:border-blue-500">
                            ...
                            <div class="col-span-3">
                                ...
                                <input type="text" name="head_addre1" id="head_addre1" value="{{old('head_addre1')}}" class="w-full py-1 mt-1 placeholder-gray-400 border border-gray-300 rounded-e rounded-s" placeholder="">
                            </div>
                            <div class="">
                                <label for="head_tel" class="font-semibold dark:text-gray-100 text-gray-900 leading-none mt-4">代表TEL（-）</label>
                                <input type="text" name="head_tel" pattern="\d{2,4}-?\d{2,4}-?\d{3,4}" maxlength="13" id="head_tel" value="{{old('head_tel')}}" class="w-full py-1 mt-1 placeholder-gray-400 border border-gray-300 rounded-e rounded-s" placeholder="">
                            </div>
        
                            <div class="">
                                <label for="head_fax" class="font-semibold dark:text-gray-100 text-gray-900 leading-none mt-4">代表FAX（-）</label>
                                <input type="tel" name="head_fax" pattern="\d{2,4}-?\d{2,4}-?\d{3,4}" maxlength="13" id="head_fax" value="{{old('head_fax')}}" class="w-full py-1 mt-1 placeholder-gray-400 border border-gray-300 rounded-e rounded-s"  placeholder="">
                            </div>
                        </div>
                        ...
                        <div class="grid gap-4 mb-1 sm:grid-cols-5 mt-1">
                            <div class="w-full flex flex-col">
                                ...
                                <input type="number" min="0" name="students" class="w-full py-1 placeholder-gray-400 border border-gray-300 rounded-e rounded-s mt-1" id="students" value="{{old('students')}}">
                            </div>
                        </div>
                        <div class="grid gap-4 mb-1 sm:grid-cols-5 mt-1">
                            <div class="w-full flex flex-col">
                                <label for="distribution" class="font-semibold dark:text-gray-100 text-gray-900 leading-none mt-4">商流</label>
                                <select id="distribution_type_id" name="distribution_type_id" class="w-full mt-1 block p-1.5 text-sm bg-gray-50 border border-gray-300 text-gray-900 rounded-e rounded-s focus:ring-blue-500 focus:border-blue-500 dark:border-gray-600 dark:placeholder-gray-400 dark:focus:ring-blue-500 dark:focus:border-blue-500">
                                    <option selected value="">未選択</option>
                        ...
                        <button type="button"  onclick="showDistributionModal()" class="md:mt-10 mt-6 w-full md:w-auto whitespace-nowrap text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-e rounded-s text-sm px-4 py-3 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">
                            ディーラ検索
                        </button>
                        <div class="grid gap-4 mt-1 mb-4 sm:grid-cols-5">
                            ...
                            <div class="w-full flex flex-col hidden">
                                ...
                                <input form="updateForm" type="text" name="distribution_id" class="w-auto py-1 border border-gray-300 rounded-e rounded-s mt-1 mb-2" id="distribution_id" value="{{old('distribution_id')}}" placeholder="">
                            </div>
                            <div class="w-full flex flex-col">
                                <label for="distribution_num" class="font-semibold dark:text-gray-100 text-gray-900 leading-none mt-1">ディーラ（法人）№</label>
                                <input type="text" name="distribution_num" class="dark:bg-gray-400 w-auto py-1 border border-gray-300 rounded-e rounded-s mt-1" id="distribution_num" value="{{old('distribution_num')}}" disabled>
                            </div>
                            <div class="w-full flex flex-col col-span-3">
                                ...
                                <input type="text" name="distribution_name" class="dark:bg-gray-400 w-auto py-1 border border-gray-300 rounded-e rounded-s mt-1 mb-2" id="distribution_name" value="{{old('distribution_name')}}" disabled>
                            </div>
                        </div>
    
                        <div class="w-full flex flex-col">
                            <label for="memo" class="font-semibold dark:text-gray-100 text-gray-900 leading-none mt-4">備考</label>
                            <textarea name="memo" data-auto-resize="true" class="w-auto py-1 border border-gray-300 rounded-e rounded-s mt-1 placeholder-gray-400" id="auto-resize-textarea-client_memo" value="{{old('memo')}}" cols="30" rows="5">{{old('memo')}}</textarea>
                        </div>

                        <ul class=" mt-4 items-center w-full text-sm font-medium text-gray-900 bg-white border border-gray-200 rounded-e rounded-s sm:flex dark:bg-gray-700 dark:border-gray-600 dark:text-white">
                    ...
                    <div class="hidden p-4 rounded-e rounded-s bg-gray-50 dark:bg-gray-800" id="dashboard" role="tabpanel" aria-labelledby="dashboard-tab">
                        {{-- content --}}
                    </div>
                    <div class="hidden p-4 rounded-e rounded-s bg-gray-50 dark:bg-gray-800" id="settings" role="tabpanel" aria-labelledby="settings-tab">
                        {{-- content --}}
                    </div>
                    <div class="hidden p-4 rounded-e rounded-s bg-gray-50 dark:bg-gray-800" id="contacts" role="tabpanel" aria-labelledby="contacts-tab">
                        {{-- content --}}
                    </div>
            </div>
        </div>
    ...
    {{-- <div id="corporationSearchModal" tabindex="-1" class="fixed top-0 left-0 right-0 z-50 hidden w-full p-4 overflow-x-hidden overflow-y-auto md:inset-0 h-[calc(100%-1rem)] max-h-full justify-center items-center"> --}}
        <div class="max-h-full w-full max-w-2xl">
            <!-- Modal content -->
            <div class="relative p-4 bg-white rounded-e rounded-s shadow dark:bg-gray-700">
                <!-- Modal header -->
                <div class="flex items-center justify-between p-5 border-b rounded-t dark:border-gray-600">
                    <h3 class="text-xl font-medium text-gray-900 dark:text-white">
                        法人検索画面
                    </h3>
                    <button type="button" onclick="hideModal()" class="text-gray-400 bg-transparent hover:bg-gray-200 hover:text-gray-900 rounded-e rounded-s text-sm w-8 h-8 ml-auto inline-flex justify-center items-center dark:hover:bg-gray-600 dark:hover:text-white">
                ...
                <form action="{{ route('clientcorporation.search') }}" method="GET">
                    ...
                    {{-- <div class="flex flex-wrap justify-start mx-5"> --}}
                        <div class="">
                            ...
                            <input type="text" name="corporationName" id="corporationName" class="block w-full mt-1 mr-2 py-1 placeholder-gray-400 border border-gray-300 rounded-e rounded-s">
                        </div>
                        <div class="">
                            <label for="corporationNumber" class="block font-semibold dark:text-gray-100 text-gray-900 leading-none">法人番号</label>
                            <input type="text" name="corporationNumber" id="corporationNumber" class="block w-full mt-1 mr-2 py-1 placeholder-gray-400 border border-gray-300 rounded-e rounded-s">
                        </div>
                    </div>
                </form>
                ...
                <div class="flex items-center p-6 space-x-2 border-t border-gray-200 rounded-b dark:border-gray-600">
                    <button type="button" onclick="searchCorporation()" class="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-e rounded-s text-sm px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">
                        検索
                    </button>
                    <button type="button" onclick="hideModal()" class="text-gray-500 bg-white hover:bg-gray-100 focus:ring-4 focus:outline-none focus:ring-gray-200 rounded-e rounded-s border border-gray-200 text-sm font-medium px-5 py-2.5 hover:text-gray-900 focus:z-10 dark:bg-gray-700 dark:text-gray-300 dark:border-gray-500 dark:hover:text-white dark:hover:bg-gray-600 dark:focus:ring-gray-600">
                        閉じる
                    </button> 
                </div>
            </div>
            ...
            <div class="max-h-full w-full max-w-2xl">
                ...
                <div class="relative p-4 bg-white rounded-e rounded-s shadow dark:bg-gray-700">
                    ...
                    <div class="flex items-center justify-between p-5 border-b rounded-t dark:border-gray-600">
                        ...
                        <button type="button" onclick="hideDistributionModal()" class="text-gray-400 bg-transparent hover:bg-gray-200 hover:text-gray-900 rounded-e rounded-s text-sm w-8 h-8 ml-auto inline-flex justify-center items-center dark:hover:bg-gray-600 dark:hover:text-white">
                            <svg class="w-3 h-3" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 14 14">
                                <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="m1 1 6 6m0 0 6 6M7 7l6-6M7 7l-6 6"/>
                            </svg>
                            <span class="sr-only">Close modal</span>
                    ...
                    <form action="{{ route('clientcorporation.search') }}" method="GET">
                        ...
                        {{-- <div class="flex flex-wrap justify-start mx-5"> --}}
                            <div class="">
                                ...
                                <input type="text" name="distributionName" id="distributionName" class="block w-full mt-1 mr-2 py-1 placeholder-gray-400 border border-gray-300 rounded-e rounded-s">
                            </div>
                            <div class="">
                                <label for="distributionNumber" class="block font-semibold dark:text-gray-100 text-gray-900 leading-none">法人番号</label>
                                <input type="text" name="distributionNumber" id="distributionNumber" class="block w-full mt-1 mr-2 py-1 placeholder-gray-400 border border-gray-300 rounded-e rounded-s">
                            </div>
                        </div>
                    </form>
                    <div class=" max-h-80 overflow-y-auto overflow-x-hidden mt-4">
                    ...
                    <!-- Modal footer -->
                    <div class="flex items-center p-6 space-x-2 border-t border-gray-200 rounded-b dark:border-gray-600">
                        <button type="button" onclick="searchDistribution()" class="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-e rounded-s text-sm px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">
                            検索
                        </button>
                        <button type="button" onclick="hideDistributionModal()" class="text-gray-500 bg-white hover:bg-gray-100 focus:ring-4 focus:outline-none focus:ring-gray-200 rounded-e rounded-s border border-gray-200 text-sm font-medium px-5 py-2.5 hover:text-gray-900 focus:z-10 dark:bg-gray-700 dark:text-gray-300 dark:border-gray-500 dark:hover:text-white dark:hover:bg-gray-600 dark:focus:ring-gray-600">
                            閉じる
                        </button> 
                    </div>
                </div>
...
//ディーラ（法人）検索モーダル関連
    ...
    function searchDistribution() {
        const corporationName = document.getElementById('distributionName').value;
        const corporationNumber = document.getElementById('distributionNumber').value;
        ...
        .then(data => {
            ...
            resultElement.classList.add('dark:border-gray-700', 'hover:bg-gray-600', 'dark:text-white', 'border-b-white')
            resultElement.innerHTML = `
                <td tabindex="1" class="py-2 pl-5 cursor-pointer" onclick="setDistribution('${result.id}', '${result.clientcorporation_num}', '${result.clientcorporation_name}')">${result.clientcorporation_short_name}</td>
                <td class="py-2 ml-2">${result.clientcorporation_num}</td>
            `;
