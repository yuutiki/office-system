    ...
    <body class="antialiased">
        <div class="relative flex items-top justify-center min-h-screen bg-gray-100 dark:bg-gray-900 sm:items-center sm:pt-0">
            <div class="max-w-xl mx-auto sm:px-6 lg:px-8">
                ...
                <div class="mt-8 text-center text-lg text-gray-500 uppercase tracking-wider">
                    <a class="underline" href="{{ route('dashboard') }}">ホームへ戻る</a>
                </div>
            </div>
        </div>
    </body>
            ...
            <div class="space-y-8 fade-in-up delay-1">
                <div>
                    ...
                    <p class="text-slate-400 leading-relaxed">
                        セキュリティ保護のため、セッションの有効期限が切れました。お手数ですが、もう一度お試しください。
                    </p>
                </div>
