    ...
    <body class="flex items-center justify-center h-screen bg-gray-700">
        ...
        <section class="bg-gray-700">
            <div class="py-8 px-4 mx-auto max-w-screen-md text-center lg:py-16 lg:px-12">
                ...
                <h1 class="mb-4 text-4xl font-bold tracking-tight leading-none text-gray-900 lg:mb-6 md:text-5xl xl:text-6xl dark:text-white">メンテナンス中</h1>
                <p class="font-light text-gray-500 md:text-lg xl:text-xl dark:text-gray-400">申し訳ありませんが、サイトは現在メンテナンス中です。<br>ご迷惑をおかけいたしますが、しばらくお待ちください。</p>
            </div>
        </section>
    </body>
</html>