            ...
            <form id="form1" method="post" action="{{route('project.store')}}" enctype="multipart/form-data" autocomplete="new-password">
                ...
                <div class="grid gap-4 mb-4 sm:grid-cols-3">
                    <div class="">
                        ...
                        <input type="text" name="corporation_name" class="dark:bg-gray-400 w-full py-1 placeholder-gray-400 border border-gray-300 rounded-s rounded-e mt-1 cursor-not-allowed" id="corporation_name" value="{{old('corporation_name')}}" placeholder="顧客検索してください" readonly>
                    ...
                    <div class="hidden">
                        ...
                        <input type="text" name="client_num" id="client_num" value="{{old('client_num')}}" class="dark:bg-gray-400 w-full py-1 placeholder-gray-400 border border-gray-300 rounded-s rounded-e mt-1 cursor-not-allowed">
                    </div>
                    <div class="">
                        <label for="client_name" class="block font-semibold dark:text-gray-100 text-gray-900 leading-none md:mt-4">顧客名称</label>
                        <input type="text" name="client_name" class="dark:bg-gray-400 w-full py-1 placeholder-gray-400 border border-gray-300 rounded-s rounded-e mt-1 cursor-not-allowed" id="client_name" value="{{old('client_name')}}" placeholder="顧客検索してください" readonly>
                        @error('client_name')
                            <div class="text-red-500">{{ $message }}</div>
                        @enderror
                    </div>
                    ...
                    <div class="">
                        ...
                        <input type="text" name="project_num" class="dark:bg-gray-400 w-full py-1 placeholder-gray-400 border border-gray-300 rounded-s rounded-e mt-1 cursor-not-allowed" id="project_num" value="{{old('project_num')}}" placeholder="登録時に自動採番されます" readonly>
                        @error('project_num')
                            <div class="text-red-500">{{ $message }}</div>
                        @enderror
                    </div>
                    <div class="col-span-2">
                        ...
                        <input type="text" name="project_name" class="w-full py-1 placeholder-gray-400 border border-gray-300 rounded-s rounded-e mt-1" id="project_name" value="{{old('project_name')}}" placeholder="">
                        @error('project_name')
                            <div class="text-red-500">{{ $message }}</div>
                        @enderror
                    </div>
                    ...
                    <div class="hidden p-4 rounded-s rounded-e bg-gray-50 dark:bg-gray-800" id="profile" role="tabpanel" aria-labelledby="profile-tab">
                        <div class="grid gap-4 mb-4 md:grid-cols-5 grid-cols-2">
                            <div>
                                ...
                                <select id="sales_stage_id" name="sales_stage_id" class="bg-gray-50 border border-gray-300 text-gray-900 rounded-s rounded-e focus:ring-blue-500 focus:border-blue-500 block w-full p-1.5 text-sm dark:border-gray-600 dark:placeholder-gray-400 dark:focus:ring-blue-500 dark:focus:border-blue-500">
                                    <option value="">未選択</option>
                            ...
                            <div>
                                ...
                                <select id="project_type_id" name="project_type_id" class="bg-gray-50 border border-gray-300 text-gray-900 rounded-s rounded-e focus:ring-blue-500 focus:border-blue-500 block w-full p-1.5 text-sm  dark:border-gray-600 dark:placeholder-gray-400 dark:focus:ring-blue-500 dark:focus:border-blue-500">
                                    <option value="">未選択</option>
                            ...
                            <div>
                                ...
                                <select id="accounting_type_id" name="accounting_type_id" class="bg-gray-50 border border-gray-300 text-gray-900 rounded-s rounded-e focus:ring-blue-500 focus:border-blue-500 block w-full p-1.5 text-sm dark:border-gray-600 dark:placeholder-gray-400 dark:focus:ring-blue-500 dark:focus:border-blue-500">
                                    <option value="">未選択</option>
                            ...
                            <div>
                                ...
                                <select id="distribution_type_id" name="distribution_type_id" class="bg-gray-50 border border-gray-300 text-gray-900 rounded-s rounded-e focus:ring-blue-500 focus:border-blue-500 w-full p-1.5 text-sm dark:border-gray-600 dark:placeholder-gray-400 dark:focus:ring-blue-500 dark:focus:border-blue-500">
                                    <option value="">未選択</option>
                        ...
                        <div class="grid gap-2 mb-4 sm:grid-cols-4">
                            <div class="w-full flex flex-col">
                                ...
                                <input type="number" name="total_revenue" id="total_revenue" value="" class="dark:bg-gray-400 dark:text-white w-auto py-1 placeholder-gray-400 border border-gray-300 rounded-s rounded-e mt-1" disabled>
                            </div>
                            {{-- <div class="w-full flex flex-col">
                        ...
                        <button type="button"  onclick="showCorporationModal()" class="md:ml-1 md:mt-1 mt-1 mb-2 w-full md:w-auto whitespace-nowrap text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-s rounded-e text-sm px-4 py-3 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">
                            法人検索
                        </button>
                        ...
                        <div class="grid gap-2 mb-4 sm:grid-cols-4">
                            ...
                            <div class="w-full flex flex-col hidden">
                                ...
                                <input type="text" name="billing_corporation_id" class="w-auto py-1 placeholder-gray-400 border border-gray-300 rounded-s rounded-e mt-1 mb-2" id="billing_corporation_id" value="{{old('billing_corporation_id')}}" placeholder="">
                            </div>
                            <div class="w-full flex flex-col">
                                <label for="billing_corporation_num" class="font-semibold dark:text-gray-100 text-gray-900 leading-none mt-4">請求先法人№</label>
                                <input type="text" name="billing_corporation_num" class="w-auto py-1 placeholder-gray-400 border border-gray-300 rounded-s rounded-e mt-1 mb-2" id="billing_corporation_num" value="{{old('billing_corporation_num')}}" placeholder="">
                            </div>
                            <div class="w-full flex flex-col">
                        ...
                        <div class="grid gap-4 my-4 sm:grid-cols-4">
                            ...
                            <div>
                                ...
                                <select id="account_department_id" name="account_department_id" class="bg-gray-50 border border-gray-300 text-gray-900 rounded-s rounded-e focus:ring-blue-500 focus:border-blue-500 block w-full p-1.5 text-sm  dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                                    @foreach($departments as $department)
                            ...
                            <div>
                                ...
                                <select id="account_user_id" name="account_user_id" class="bg-gray-50 border border-gray-300 text-gray-900 rounded-s rounded-e focus:ring-blue-500 focus:border-blue-500 block w-full p-1.5 text-sm  dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
        ...
        function searchClient() {
            ...
            .then(data => {
                ...
                resultElement.innerHTML = `
                    <td class="py-2 pl-5 cursor-pointer" onclick="setClient('${result.corporation.corporation_name}', '${result.client_num}', '${result.client_name}', '${result.department_id}')">${result.client_name}</td>
