                ...
                <div class="hidden p-4 rounded bg-gray-50 dark:bg-gray-800" id="profile" role="tabpanel" aria-labelledby="profile-tab">
                    ...
                    <div class="grid gap-4 mb-4 md:grid-cols-6 grid-cols-2">
                        <div class="w-full flex flex-col">
                            ...
                            <input type="text" name="total_revenue" id="total_revenue" value="{{ number_format($totalRevenue) }}" class="dark:bg-gray-400 text-right w-auto py-1 placeholder-gray-400 border border-gray-300 rounded mt-1" disabled>
                        </div>
                                ...
                                @foreach ($revenuesWithPeriod as $projectRevenue)
                                    <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-100 dark:hover:bg-gray-600 dark:text-white">
                                        ...
                                        <td class="px-2 py-2 text-center">
                                            <button id="updateProductButton" data-modal-target="updateRevenueModal-{{ $projectRevenue['revenue']->id }}" data-modal-show="updateRevenueModal-{{ $projectRevenue['revenue']->id }}"  class="block whitespace-nowrap text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded text-sm px-2 py-1 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800 m-auto" type="button">
                                                <div class="flex">
                    ...
                    <div>
                        ...
                        <div class="grid gap-4 mt-1 sm:grid-cols-6">
                            ...
                            <div class="w-full flex flex-col">
                                ...
                                <input type="text" name="billing_corporation_num" class="dark:bg-gray-400 w-auto py-1 border border-gray-300 rounded mt-1 mb-1" id="billing_corporation_num" value="{{old('billing_corporation_num',$project->client->corporation->corporation_num)}}" disabled>
                            </div>
                            <div class="w-full flex flex-col col-span-2">
                                ...
                                <input type="text" name="billing_corporation_name" class="dark:bg-gray-400 w-auto py-1 border border-gray-300 rounded mt-1 mb-1" id="billing_corporation_name" value="{{old('billing_corporation_name',$project->client->corporation->corporation_name)}}" disabled>
                            </div>
                        </div>
                        <div class="grid gap-4 mt-1 sm:grid-cols-6">
                            <div class="w-full flex flex-col col-span-3">
                                ...
                                <input type="text" name="billing_corporation_name" class="dark:bg-white w-auto py-1 border border-gray-300 rounded mt-1 mb-1" id="billing_corporation_name" value="{{old('billing_corporation_name',$project->billing_corporation_name)}}">
                            </div>
                        </div>
                        <div class="grid gap-4 mt-1 sm:grid-cols-6">
                            <div class="w-full flex flex-col col-span-3">
                                ...
                                <input type="text" name="billing_corporation_division_name" class="dark:bg-white w-auto py-1 border border-gray-300 rounded mt-1 mb-1" id="billing_corporation_division_name" value="{{old('billing_corporation_division_name',$project->billing_corporation_dibvision_name)}}">
                            </div>
                        </div>
                        <div class="grid gap-4 mt-1 sm:grid-cols-6">
                            <div class="w-full flex flex-col col-span-3">
                                ...
                                <input type="text" name="billing_corporation_person_name" class="dark:bg-white w-auto py-1 border border-gray-300 rounded mt-1 mb-1" id="billing_corporation_person_name" value="{{old('billing_corporation_person_name',$project->client->billing_corporation_person_name)}}">
                            </div>
                        </div>
                        <div class="grid gap-4 mt-1 sm:grid-cols-5">
                            <div class="">
                                ...
                                <input type="text" name="billing_head_post_code" class="w-full py-1 placeholder-gray-400 border border-gray-300 rounded mt-1" id="billing_head_post_code" value="{{old('billing_head_post_code',$project->billing_head_post_code)}}" placeholder="" onKeyUp="AjaxZip3.zip2addr(this,'','billing_head_prefecture','billing_head_addre1','','',false);">
                            </div>
                            <div class="">
                                <label for="billing_head_prefecture" class="font-semibold dark:text-gray-100 text-gray-900 leading-none mt-4 ">都道府県</label>
                                <select id="billing_head_prefecture" name="billing_head_prefecture" class="w-full py-1.5  text-sm mt-1 bg-gray-50 border border-gray-300 text-gray-900 rounded focus:ring-blue-500 focus:border-blue-500 dark:bg-white dark:border-gray-600 dark:placeholder-gray-400 dark:text-black dark:focus:ring-blue-500 dark:focus:border-blue-500">
                        ...
                        <div class="grid gap-4 mt-1 mb-4 sm:grid-cols-6">
                            <div class="col-span-3">
                                ...
                                <input type="text" name="billing_head_addre1" id="billing_head_addre1" value="{{old('billing_head_addre1',$project->billing_head_address1)}}" class="w-full py-1 mt-1 placeholder-gray-400 border border-gray-300 rounded" placeholder="">
                            </div>
                        </div>
                        ...
                        <form id="updateForm" method="post" action="{{route('projects.update', $project)}}" enctype="multipart/form-data" autocomplete="new-password">
                            @csrf
                            @method('patch')
