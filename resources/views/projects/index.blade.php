<x-app-layout>
    ...
    <div id="accordion-color" data-accordion="collapse" data-active-classes="bg-blue-100 dark:bg-gray-800 text-blue-600 dark:text-white">
        ...
        {{-- 絞り込み検索 --}}
            <div class="w-5/6 border border-t-0 mx-auto h-auto dark:text-white rounded-b-md">
                <form method="GET" action="{{ route('corporations.index') }}" id="corporationform">
                    @csrf
                    <div class="grid gap-4 mt-1 mb-4 sm:grid-cols-5 p-2">
                        {{-- テキスト検索 start --}}
                        <div class="relative w-auto mt-2">
                            <div class="absolute inset-y-0 left-0 flex items-center pl-3 pointer-events-none">
                                <svg aria-hidden="true" class="w-5 h-5 text-gray-500 dark:text-gray-400" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M21 21l-6-6m2-5a7 7 0 11-14 0 7 7 0 0114 0z"></path></svg>
                            </div>
                            <input type="search" name="corporation_num" value="@if (isset($corporation_num)){{ $corporation_num }}@endif" class="w-full p-1.5 pl-10  text-sm text-gray-900 border border-gray-300 rounded-lg bg-gray-50 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="PJ番号" >
                        </div>
                        <div class="relative w-auto mt-2">
                            <div class="absolute inset-y-0 left-0 flex items-center pl-3 pointer-events-none">
                                <svg aria-hidden="true" class="w-5 h-5 text-gray-500 dark:text-gray-400" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M21 21l-6-6m2-5a7 7 0 11-14 0 7 7 0 0114 0z"></path></svg>
                            </div>
                            <input type="search" name="corporation_name" value="@if (isset($corporation_name)){{ $corporation_name }}@endif" class="w-full p-1.5 pl-10  text-sm text-gray-900 border border-gray-300 rounded-lg bg-gray-50 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="法人名称" >
                        </div>
                        <div class="relative w-auto mt-2">
                            <div class="absolute inset-y-0 left-0 flex items-center pl-3 pointer-events-none">
                                <svg aria-hidden="true" class="w-5 h-5 text-gray-500 dark:text-gray-400" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M21 21l-6-6m2-5a7 7 0 11-14 0 7 7 0 0114 0z"></path></svg>
                            </div>
                            <input type="search" name="corporation_kana_name" value="@if (isset($corporation_kana_name)){{ $corporation_kana_name }}@endif" class="w-full p-1.5 pl-10  text-sm text-gray-900 border border-gray-300 rounded-lg bg-gray-50 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="顧客名称" >
                        </div>
                        {{-- テキスト検索 end --}}
                        {{-- セレクト検索 start --}}
                        <select  name="project_type" class="mt-2 w-auto  py-1.5 bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                        ...
                        <select  name="project_type" class="mt-2 w-auto  py-1.5 bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                            <option value="">営業段階</option>
                            @foreach($salesStages as $salesStage)
                                <option value="{{$salesStage->id}}">{{$salesStage->sales_stage_name}}</option>
                            @endforeach
                        </select>
                        <select  name="accounting_period" class="mt-2 w-auto  py-1.5 bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                            <option value="">計上期</option>
                            @foreach($accountingPeriods as $accountingPeriod)
                                <option value="{{$accountingPeriod->id}}">{{$accountingPeriod->period_name}}</option>
                            @endforeach
                        </select>
                        {{-- セレクト検索 end --}}
                        {{-- 日付範囲検索 start --}}
                        ...
                        {{-- 日付範囲検索 end --}}
                        <select  name="user" class="mt-2 w-auto  py-1.5 bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                        ...
                        <div class="form-check">
                            ...
                            <label for="unreturned_only" class=" text-sm font-medium text-gray-900 dark:text-gray-300">返却済みも含む</label>
                        </div>
                        <div class="">
                            <button type="submit" form="keepfileform" class="px-6 py-1.5 font-medium text-sm rounded-md text-white focus:outline-none focus:ring-4 focus:ring-blue-300 bg-blue-700 hover:bg-blue-800 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">検索</button>
                            <button type="button" value="reset" form="keepfileform" id="clear" class=" px-4 py-1.5 font-medium text-sm rounded-md text-white focus:outline-none focus:ring-4 focus:ring-blue-300 bg-red-700 hover:bg-red-800 dark:bg-red-600 dark:hover:bg-red-700 dark:focus:ring-blue-800">リセット</button>
                        </div>
                    </div>
                </form>
            </div>
    ...
    <div id="dropdown" class="z-10 hidden bg-white divide-y divide-gray-100 rounded-lg shadow w-44 dark:bg-gray-700">
        <ul class="py-2 text-sm text-gray-700 dark:text-gray-200" aria-labelledby="dropdownDefaultButton">
            ...
            <li>
                <a href="/project/create" class="block text-left pl-8 py-2 font-medium text-sm hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white">
                    手動登録
                </a>
            </li>
        </ul>
            ...
            <div class="relative w-full max-w-2xl max-h-full">
                ...
                <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                    ...
                    <div class="p-6 space-y-6 mr-20 mt-4">
                        <form action="{{ route('project.upload') }}" method="POST" enctype="multipart/form-data" class="flex items-center" id="csv_upload">
                            @csrf
                    ...
                    <div class="flex justify-end p-3 space-x-2 border-t border-gray-200 rounded-b dark:border-gray-600">
                        <!-- モーダルオーバーレイ -->
                        <button type="submit" form="csv_upload" id="upload-button" class="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-blue-600 dark:hover-bg-blue-700 dark:focus-ring-blue-800">
                            アップロード
                        </button>
            ...
            @foreach ($projects as $project)
                <tbody>
                    <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-600 dark:text-white">
                        ...
                        <td class="pl-4 py-2 whitespace-nowrap">
                            <button onclick="location.href='{{route('projects.edit',$project)}}'"  class="button-edit" type="button">
                                <div class="flex">
                        ...
                        <td class="px-1 py-2 whitespace-nowrap">
                            {{-- {{ number_format($project->unit_price, 0, '.', ',')}} --}}
                        ...
                        <td class="px-1 py-2">
                            <button data-modal-target="deleteModal-{{$project->id}}" data-modal-toggle="deleteModal-{{$project->id}}"  class="button-delete" type="button">
                                <div class="flex">
                ...
                <div id="deleteModal-{{$project->id}}" tabindex="-1" class="fixed top-0 left-0 right-0 z-50 hidden p-4 overflow-x-hidden overflow-y-auto md:inset-0 h-[calc(100%-1rem)] max-h-full">
                    <div class="relative w-full max-w-md max-h-full">
                        <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                            <button data-modal-hide="deleteModal-{{$project->id}}" type="button" class="absolute top-3 right-2.5 text-gray-400 bg-transparent hover:bg-gray-200 hover:text-gray-900 rounded-lg text-sm w-8 h-8 ml-auto inline-flex justify-center items-center dark:hover:bg-gray-600 dark:hover:text-white">
                            ...
                            <div class="p-6 text-center">
                                ...
                                <button data-modal-hide="deleteModal-{{$project->id}}" type="button" class="text-gray-500 bg-white hover:bg-gray-100 focus:ring-4 focus:outline-none focus:ring-gray-200 rounded-lg border border-gray-200 text-sm font-medium px-5 py-2.5 hover:text-gray-900 focus:z-10 dark:bg-gray-700 dark:text-gray-300 dark:border-gray-500 dark:hover:text-white dark:hover:bg-gray-600 dark:focus:ring-gray-600">
                                    やっぱやめます
                                </button>
                            </div>
                        </div>
    ...
    <script>
        ...
        const uploadForm = document.getElementById('csv_upload');
