<x-app-layout>
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 my-4">
        <form id="form1" method="post" action="{{ route('contracts.details.update', ['contract' => $contract, 'detail' => $detail]) }}" enctype="multipart/form-data">
            @csrf
            @method('put')
            <div class="p-2 md:p-8 rounded-lg bg-gray-50 shadow-md dark:bg-gray-800" >
                ...
                <div class="grid gap-4 my-4 md:grid-cols-4">
                    <div>
                        ...
                        <select name="contract_change_type_id" id="contract_change_type_id" value="{{old('contract_change_type_id')}}" class="input-primary">
                            ...
                            <option value="{{ $contractChangeType->id }}"  @selected($contractChangeType->id == old('contract_change_type_id', $detail->contract_change_type_id))>{{ $contractChangeType->contract_change_type_name }}</option>
                            @endforeach
                        </select>
                    ...
                    <div>
                        ...
                        <select name="contract_update_type_id" id="contract_update_type_id" value="{{old('contract_update_type_id')}}" class="input-primary">
                            ...
                            <option value="{{ $contractUpdateType->id }}"  @selected($contractUpdateType->id == old('contract_update_type_id', $detail->contract_update_type_id))>{{ $contractUpdateType->contract_update_type_name }}</option>
                            @endforeach
                        </select>
                    ...
                    <div>
                        ...
                        <select name="contract_sheet_status_id" id="contract_sheet_status_id" value="{{old('contract_sheet_status_id')}}" class="input-primary">
                            ...
                            <option value="{{ $contractSheetStatus->id }}"  @selected($contractSheetStatus->id == old('contract_sheet_status_id', $detail->contract_sheet_status_id))>{{ $contractSheetStatus->contract_sheet_status_name }}</option>
                            @endforeach
                        </select>
                    ...
                    <div>
                        ...
                        <select name="contract_partner_type_id" id="contract_partner_type_id" value="{{old('contract_partner_type_id')}}" class="input-primary">
                            ...
                            <option value="{{ $contractPartnerType->id }}"  @selected($contractPartnerType->id == old('contract_partner_type_id', $detail->contract_partner_type_id))>{{ $contractPartnerType->contract_partner_type_name }}</option>
                            @endforeach
                        </select>
                ...
                <div class="grid gap-4 md:grid-cols-2 mt-4">
                    <div>
                        ...
                        <input type="date" min="1900-01-01" max="2200-12-31" name="contract_start_at" id="contract_start_at" value="{{ old('contract_start_at', $detail->contract_start_at) }}" class="input-primary">
                    ...
                    <div>
                        ...
                        <input type="date" min="1900-01-01" max="2200-12-31" name="contract_end_at" id="contract_end_at" value="{{ old('contract_end_at', $detail->contract_end_at) }}" class="input-primary">
                ...
                <div class="mt-4">
                    ...
                    <input type="text" onblur="formatNumberInput(this);" maxlength="100" name="contract_amount" id="contract_amount" value="{{old('contract_amount', number_format($detail->contract_amount))}}" class="input-primary">
                ...
                <div class="w-full flex flex-col">
                    ...
                    <textarea name="target_system" id="target_system" class="input-primary" data-auto-resize="true"  cols="30" rows="4" data-auto-resize="true">{{ old('target_system', $detail->target_system) }}</textarea>
                    @error('target_system')
                        <div class="text-red-500">{{ $message }}</div>
                    @enderror
                </div>
                <div class="w-full flex flex-col">
                    ...
                    <textarea name="contract_detail_memo" id="contract_detail_memo" class="input-primary" data-auto-resize="true"  cols="30" rows="4" data-auto-resize="true">{{ old('contract_detail_memo', $detail->contract_detail_memo) }}</textarea>
                ...
                <div class="grid gap-4 my-4 md:grid-cols-5">
                    <div class="">
                        ...
                        <div class="relative w-full">
                            <input type="text" name="project_num" id="project_num" value="{{old('project_num', optional($detail->project)->project_num)}}" class="dark:bg-gray-400 w-full py-1 border border-gray-700 rounded" readonly>
                    ...
                    <div class="hidden">
                        ...
                        <input type="text" maxlength="100" name="project_id" id="project_id" value="{{old('project_id', $detail->project_id)}}" class="dark:bg-gray-400 w-full py-1 border border-gray-700 rounded" tabindex="-1">
                        @error('project_id')
                            <div class="text-red-500">{{ $message }}</div>
                        @enderror
                    </div>
                    <div  class="md:col-span-2">
                        ...
                        <input type="text" maxlength="100" name="project_name" id="project_name" value="{{old('project_name', optional($detail->project)->project_name)}}" class="dark:bg-gray-400 w-full py-1 border border-gray-700 rounded" tabindex="-1" readonly>
                        @error('project_name')
                            <div class="text-red-500">{{ $message }}</div>
                        @enderror
                    </div>
                    <div>
                        ...
                        <input type="text" maxlength="100" name="account_user" id="account_user" value="{{ old('account_user', optional(optional($detail->project)->accountUser)->name) }}" class="dark:bg-gray-400 w-full py-1 border border-gray-700 rounded" tabindex="-1" readonly>
                        @error('account_user')
                            <div class="text-red-500">{{ $message }}</div>
                        @enderror
                    </div>
                    <div>
                        ...
                        <input type="text" maxlength="100" name="sales_stage_name" id="sales_stage_name" value="{{old('sales_stage_name', optional(optional($detail->project)->salesStage)->sales_stage_name)}}" class="dark:bg-gray-400 w-full py-1 border border-gray-700 rounded" tabindex="-1" readonly>
