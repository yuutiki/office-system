<x-app-layout>
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="mx-4 sm:p-8">
            <form method="post" action="{{route('client-person.store')}}" enctype="multipart/form-data">
                @csrf
                ...
                <label class="relative inline-flex items-center cursor-pointer">
                    ...
                    <input type="checkbox" name="is_retired" id="is_retired" value="1" @checked(old('is_retired') == 1) class="sr-only peer">
