    ...
    <x-slot name="header">
        <div class="flex justify-between">
            ...
            <div class="flex justify-end items-center space-x-2">
                ...
                <form method="post" action="{{ route('client-person.update', $clientPerson) }}" enctype="multipart/form-data" id="clientPersonForm" class="flex items-center">
                    @csrf
                    @method('patch')
    ...
    <div class="max-w-7xl mx-auto px-2 md:pl-14">
        ...
        <div class="hidden md:p-4 p-2 mb-4 rounded bg-gray-50 dark:bg-gray-800" id="base" role="tabpanel" aria-labelledby="base-tab">
            ...
            <div class="grid gap-4 md:grid-cols-3">
                <div class="flex md:mt-4 mt-4">
                    <div class="w-full flex flex-col">
                        ...
                        <input type="text" form="clientPersonForm" name="client_num" id="client_num" value="{{ old('client_num', $clientPerson->client->client_num) }}" class="input-readonly pointer-events-none" placeholder="" readonly>
                    </div>
                    <!-- 顧客検索ボタン(画面中～) -->
            ...
            <div class="w-full flex flex-col md:mt-4">
                    ...
                    <input type="text" name="client_name" id="client_name" value="{{ old('client_name', $clientPerson->client->client_name) }}" class="input-readonly pointer-events-none" placeholder="" readonly>
                </div>
            <div class="w-full flex flex-col md:mt-4">
                    ...
                    <input type="text" name="affiliation2_id" id="affiliation2_id" value="{{ old('affiliation2_id', $clientPerson->client->affiliation2->affiliation2_name) }}" class="input-readonly pointer-events-none" placeholder="" readonly>
                </div>
                @error('client_num')
            ...
            <label class="relative inline-flex items-center cursor-pointer">
                ...
                <input type="checkbox" form="clientPersonForm" name="is_retired" id="is_retired" value="1" @checked( old('is_retired', $clientPerson->is_retired) == 1) class="sr-only peer">
            ...
            <div class="grid gap-4 sm:grid-cols-2 md:mx-4">
                <div>
                    <div class="w-full flex flex-col">
                        ...
                        <input type="text" form="clientPersonForm" name="last_name" id="last_name" value="{{ old('last_name', $clientPerson->last_name) }}" class="input-secondary" placeholder="">
                    </div>
                    @error('last_name')
                        <div class="text-red-500">{{$message}}</div>
                    @enderror
                ...
                <div>
                    <div class="w-full flex flex-col">
                        ...
                        <input type="text" form="clientPersonForm" name="first_name" id="first_name" value="{{ old('first_name', $clientPerson->first_name) }}" class="input-secondary" placeholder="">
                    </div>
                    @error('first_name')
                        <div class="text-red-500">{{$message}}</div>
                    @enderror
                ...
                <div>
                    <div class="w-full flex flex-col">
                        ...
                        <input type="text" form="clientPersonForm" name="last_name_kana" id="last_name_kana" value="{{ old('last_name_kana', $clientPerson->last_name_kana) }}" class="input-secondary" placeholder="">
                    </div>
                ...
                <div>
                    <div class="w-full flex flex-col">
                        ...
                        <input type="text" form="clientPersonForm" name="first_name_kana" id="first_name_kana" value="{{ old('first_name_kana', $clientPerson->first_name_kana) }}" class="input-secondary" placeholder="">
                    </div>
                ...
                <div>
                    <div class="w-full flex flex-col">
                        ...
                        <input type="text" form="clientPersonForm" name="division_name" id="division_name" value="{{ old('division_name', $clientPerson->division_name) }}" class="input-secondary" placeholder="">
                    </div>
                    @error('division_name')
                        <div class="text-red-500">{{$message}}</div>
                    @enderror
                ...
                <div>
                    <div class="w-full flex flex-col">
                        ...
                        <input type="text" form="clientPersonForm" name="position_name" id="position_name" value="{{ old('position_name', $clientPerson->position_name) }}" class="input-secondary" placeholder="">
                    </div>
                    @error('position_name')
                        <div class="text-red-500">{{$message}}</div>
                    @enderror
            ...
            <div class="grid gap-4 sm:grid-cols-2 md:mx-4">
                <div>
                    <div class="w-full flex flex-col">
                        ...
                        <input type="text" form="clientPersonForm" name="tel1" id="tel1" onchange="validateAndFormat('tel1')" value="{{ old('tel1', $clientPerson->tel1) }}" class="input-secondary" placeholder="090-1234-5678">
                    </div>
                    @error('tel1')
                        <div class="text-red-500">{{$message}}</div>
                    @enderror
                ...
                {{-- <div class="w-full flex flex-col">
                    ...
                    <input type="text" form="clientPersonForm" name="tel2" id="tel2" value="{{ old('tel2', $clientPerson->tel2) }}" class="input-secondary" placeholder="090-1234-5678">
                </div>
                @error('tel2')
                    <div class="text-red-500">{{$message}}</div>
                @enderror --}}
                <div>
                    <div class="w-full flex flex-col">
                        ...
                        <input type="text" form="clientPersonForm" name="fax1" id="fax1" onchange="validateAndFormat('fax1')" value="{{ old('fax1', $clientPerson->fax1) }}" class="input-secondary" placeholder="090-1234-5678">
                    </div>
                    @error('fax1')
                        <div class="text-red-500">{{$message}}</div>
                    @enderror
                ...
                {{-- <div class="w-full flex flex-col">
                    ...
                    <input type="text" form="clientPersonForm" name="fax2" id="fax2" value="{{ old('fax2', $clientPerson->fax2) }}" class="input-secondary" placeholder="090-1234-5678">
                </div>
                @error('fax2')
                    <div class="text-red-500">{{$message}}</div>
                @enderror --}}
                {{-- <div class="w-full flex flex-col">
                    ...
                    <input type="text" form="clientPersonForm" name="int_tel" id="int_tel" value="{{ old('int_tel', $clientPerson->int_tel) }}" class="input-secondary" placeholder="090-1234-5678">
                </div>
                @error('int_tel')
                    <div class="text-red-500">{{$message}}</div>
                @enderror --}}
                <div>
                    <div class="w-full flex flex-col">
                        ...
                        <input type="text" form="clientPersonForm" name="phone" id="phone" onchange="validateAndFormat('phone')" value="{{ old('phone', $clientPerson->phone) }}" class="input-secondary" placeholder="090-1234-5678">
                    </div>
                    @error('phone')
                        <div class="text-red-500">{{$message}}</div>
                    @enderror
                ...
                <div>
                    <div class="w-full flex flex-col">
                        ...
                        <input type="text" form="clientPersonForm" name="mail" id="mail" value="{{ old('mail', $clientPerson->mail) }}" class="input-secondary" placeholder="test@hoge.com">
                    </div>
                    @error('mail')
                        <div class="text-red-500">{{$message}}</div>
                    @enderror
            ...
            <div class="grid gap-4 sm:grid-cols-4 md:mx-4">
                <div class="col-span-1">
                    <div class="flex">
                        <div class="w-full flex flex-col">
                            ...
                            <input type="text" form="clientPersonForm" name="head_post_code" class="input-primary" id="head_post_code" value="{{ old('head_post_code', $clientPerson->head_post_code) }}" placeholder="">
                        </div>
                ...
                <div class="w-full flex flex-col">
                    <label for="head_prefecture_id" class=" text-sm dark:text-gray-100 text-gray-900 leading-none" autocomplete="new-password">都道府県</label>
                    <select id="head_prefecture_id" form="clientPersonForm" name="head_prefecture_id" class="input-secondary">
                        <option selected value="">未選択</option>
                        @foreach($prefectures as $prefecture)
                            <option value="{{ $prefecture->id }}" @if( $prefecture->id ==  old('head_prefecture_id', $clientPerson->prefecture_id) ) selected @endif>{{ $prefecture->prefecture_code }}:{{ $prefecture->prefecture_name }}</option>
                        @endforeach
                    </select>
                </div>
            </div>
            ...
            <div>
                <div class="w-full flex flex-col mt-3 md:mx-4">
                    <label for="head_addre1" class=" text-sm dark:text-gray-100 text-gray-900 leading-none" autocomplete="new-password">代表所在地</label>
                    <input type="text" form="clientPersonForm" name="head_addre1" id="head_addre1" value="{{ old('head_addre1', $clientPerson->head_address1) }}" class="input-secondary" placeholder="">
                </div>
                @error('head_addre1')
                    <div class="text-red-500">{{$message}}</div>
                @enderror
            ...
            <div>
                <div class=" flex flex-col md:mx-4">
                    ...
                    <textarea name="person_memo" form="clientPersonForm" id="person_memo" value="" class="input-secondary" cols="30" rows="5" data-auto-resize="true" placeholder="">{{ old('person_memo', $clientPerson->person_memo) }}</textarea>
                </div>           
                @error('person_memo')
                    <div class="text-red-500">{{$message}}</div>
                @enderror
