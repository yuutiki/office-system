    ...
    <x-slot name="header">
        <div class="flex justify-between">
            <h2 class="font-semibold text-xl text-gray-900 dark:text-white">
                {{ Breadcrumbs::render('csvUploadCorporation', $searchParams) }}
            </h2>
    ...
    <div class="w-auto md:ml-14 md:mr-2 max-h-full mt-4">
        <div class="relative bg-white rounded shadow dark:bg-gray-700">
            <div class="p-4 space-y-6">
                <form action="{{ route('corporations.upload') }}" method="POST" enctype="multipart/form-data" class="" id="csv_form1">
                    @csrf
            ...
            <div class="flex justify-end p-3 space-x-2 border-t border-gray-200 rounded-b dark:border-gray-600">
                <button type="submit" form="csv_form1" id="upload-button"  class=" text-white focus:ring-2 focus:outline-none focus:ring-gray-300 font-medium rounded text-sm px-5 py-2.5 text-center bg-gray-700 hover:bg-gray-700 dark:bg-gray-500 dark:hover:bg-gray-600 dark:focus:ring-gray-700">
