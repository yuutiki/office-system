                ...
                <div class="hidden p-4 rounded-lg bg-gray-50 dark:bg-gray-800" id="profile" role="tabpanel" aria-labelledby="profile-tab">
                    <div class="grid gap-2 mb-4 sm:grid-cols-6">
                        ...
                        <div class="">
                            ...
                            <input type="text" name="f_client_user_department" class="block w-full py-1 placeholder-gray-400 border border-gray-300 rounded-md mt-1" id="f_client_user_department" value="{{old('f_client_user_department')}}" placeholder="">
                        ...
                        <div class="">
                            ...
                            <input type="text" name="f_client_user_kana_name" class="block w-full py-1 placeholder-gray-400 border border-gray-300 rounded-md mt-1" id="f_client_user_kana_name" value="{{old('f_client_user_kana_name')}}" placeholder="">
                    ...
                    <div class="w-full flex flex-col">
                        ...
                        <input type="text" name="f_title" class="w-auto py-1 placeholder-gray-400 border border-gray-300 rounded-md mt-1 " id="f_title" value="{{old('f_title')}}" placeholder="">
                        @error('f_title')
                            <div class="text-red-500">{{ $message }}</div>
                        @enderror
                    </div>
                    <div class="w-full flex flex-col">
                        ...
                        <textarea name="f_request_content" class="w-auto py-1 border text-sm border-gray-300 rounded-md mt-1 placeholder-gray-400" id="f_request_content" value="{{old('f_request_content')}}" cols="30" rows="8">{{ old('f_request_content') }}</textarea>
                    ...
                    <div class="w-full flex flex-col">
                        ...
                        <textarea name="f_response_content" class="w-auto py-1 border text-sm border-gray-300 rounded-md mt-1 placeholder-gray-400" id="f_response_content" value="{{old('f_response_content')}}" cols="30" rows="8">{{ old('f_response_content') }}</textarea>
                    </div>
                    ...
                    <div class="grid gap-2 mb-4 sm:grid-cols-2">
                        <div class="w-full flex flex-col">
                            ...
                            <textarea name="f_internal_message" class="w-auto py-1 border text-sm border-gray-300 rounded-md mt-1 placeholder-gray-400" id="f_internal_message" value="{{old('f_internal_message')}}" cols="30" rows="5">{{ old('f_internal_message') }}</textarea>
                        </div>
                        ...
                        <div class="w-full flex flex-col">
                            ...
                            <textarea name="f_internal_memo1" class="w-auto py-1 border text-sm border-gray-300 rounded-md mt-1 placeholder-gray-400" id="f_internal_memo1" value="{{old('f_internal_memo1')}}" cols="30" rows="5">{{ old('f_internal_memo1') }}</textarea>
                        </div>
