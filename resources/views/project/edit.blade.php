<x-app-layout>
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="mx-4 sm:p-8">
                            ...
                            <thead class="text-sm text-gray-700 bg-gray-50 dark:bg-gray-700 dark:text-gray-100">
                                <tr>
                                    <th scope="col" class="pl-4 py-3 w-auto">
                                        <div class="flex items-center whitespace-nowrap">
                                            <div class="flex items-center">
                                                <input type="checkbox" id="selectAllCheckbox" class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 rounded focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600">
                                            </div>
                                        </div>
                                    </th>
                                    <th scope="col" class="pl-4 py-3 w-auto">
                                    ...
                                    <th scope="col" class="flex items-center justify-center py-1">
                                        <button id="actionsDropdownButton" data-dropdown-toggle="actionsDropdown" class="w-full md:w-auto flex py-1.5 px-4 text-sm m-auto font-medium text-gray-900 focus:outline-none bg-white rounded-lg border border-gray-200 hover:bg-gray-100 hover:text-primary-700 focus:z-10 focus:ring-4 focus:ring-gray-200 dark:focus:ring-gray-700 dark:bg-gray-800 dark:text-gray-400 dark:border-gray-600 dark:hover:text-white dark:hover:bg-gray-700" type="button">
                                ...
                                @foreach ($revenuesWithPeriod as $projectRevenue)
                                    <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-600 dark:text-white">
                                        ...
                                        <td class="px-2 py-2 text-center">
                                            <button id="updateProductButton" data-modal-target="updateRevenueModal-{{ $projectRevenue['revenue']->id }}" data-modal-show="updateRevenueModal-{{ $projectRevenue['revenue']->id }}"  class="block whitespace-nowrap text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-md text-sm px-2 py-1 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800 m-auto" type="button">
                                                <div class="flex">
                                        ...
                                        <div class="relative p-4 w-full max-w-2xl h-full md:h-auto">
                                            ...
                                            <div class="relative p-4 bg-white rounded-lg shadow dark:bg-gray-800 sm:p-5">
                                                ...
                                                <div class="flex justify-between items-center pb-4 mb-4 rounded-t border-b sm:mb-5 dark:border-gray-600">
                                                    ...
                                                    <button type="button" class="text-gray-400 bg-transparent hover:bg-gray-200 hover:text-gray-900 rounded-lg text-sm p-1.5 ml-auto inline-flex items-center dark:hover:bg-gray-600 dark:hover:text-white" data-modal-hide="updateRevenueModal-{{ $projectRevenue['revenue']->id }}">
                                                        ...
                                                        <div>
                                                            <div class="w-full flex flex-col">
                                                                <div class="w-full flex flex-col">
                                                                    ...
                                                                    <input type="month" name="revenue_date" id="revenue_date" min="2000-01" max="2100-12" value="{{old('revenue_date',$projectRevenue['formatRevenueDate'])}}" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500" required>
                                                                </div>
                                                            </div>
                                                            @error('department_id')
                                                                <div class="text-red-500">{{$message}}</div>
                    ...
                    <div>
                        ...
                        <div class="grid gap-4 mt-1 sm:grid-cols-6">
                            ...
                            <div class="w-full flex flex-col col-span-2">
                                <label for="billing_corporation_name" class="font-semibold dark:text-gray-100 text-gray-900 leading-none mt-1">法人名称</label>
                        ...
                        <div class="grid gap-4 mt-1 sm:grid-cols-6">
                            <div class="w-full flex flex-col col-span-3">
                                ...
                                <input type="text" name="billing_corporation_name" class="dark:bg-white w-auto py-1 border border-gray-300 rounded-md mt-1 mb-2" id="billing_corporation_name" value="{{old('billing_corporation_name',$project->client->clientcorporation->clientcorporation_name)}}">
                            </div>
                        </div>
                        <div class="grid gap-4 mt-1 sm:grid-cols-6">
                            <div class="w-full flex flex-col col-span-3">
                                <label for="billing_corporation_name" class="font-semibold dark:text-gray-100 text-gray-900 leading-none mt-1">請求先部署名称</label>
                                <input type="text" name="billing_corporation_name" class="dark:bg-white w-auto py-1 border border-gray-300 rounded-md mt-1 mb-2" id="billing_corporation_name" value="{{old('billing_corporation_name',$project->client->clientcorporation->clientcorporation_name)}}">
                            </div>
                        </div>
                        <div class="grid gap-4 mt-1 sm:grid-cols-6">
                            <div class="w-full flex flex-col col-span-3">
                                <label for="billing_corporation_name" class="font-semibold dark:text-gray-100 text-gray-900 leading-none mt-1">請求先担当者名称</label>
                                <input type="text" name="billing_corporation_name" class="dark:bg-white w-auto py-1 border border-gray-300 rounded-md mt-1 mb-2" id="billing_corporation_name" value="{{old('billing_corporation_name',$project->client->clientcorporation->clientcorporation_name)}}">
                            </div>
                        </div>
                        <div class="grid gap-4 mt-1 sm:grid-cols-5">
                            <div class="">
                                ...
                                <input type="text" name="head_post_code" class="w-full py-1 placeholder-gray-400 border border-gray-300 rounded-md mt-1" id="head_post_code" value="{{old('head_post_code',$project->head_post_code)}}" placeholder="" onKeyUp="AjaxZip3.zip2addr(this,'','head_prefecture','head_addre1');">
                            </div>
                            <div class="">
                        ...
                        <div class="grid gap-4 mt-1 mb-4 sm:grid-cols-6">
                            <div class="col-span-3">
                                ...
                                <input type="text" name="head_addre1" id="head_addre1" value="{{old('head_addre1',$project->head_address1)}}" class="w-full py-1 mt-1 placeholder-gray-400 border border-gray-300 rounded-md" placeholder="">
                            </div>
                        </div>
                        <div class="grid gap-4 mt-6 mb-4 sm:grid-cols-6">
                            <div class="w-full flex flex-col">
            ...
            <div class="hidden p-4 rounded-lg bg-gray-50 dark:bg-gray-800" id="estimate" role="tabpanel" aria-labelledby="estimate-tab">
            </div>
        </div>
    </div>
