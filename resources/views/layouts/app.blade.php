    ...
    <script>
        function toggleDialVisibility() {
            ...
            if (dial.classList.contains('active')) {
                ...
                line1.classList.add('top-[50%]', 'translate-y-[0px]', 'rotate-[-45deg]', 'w-[50%]', 'left-[13px]');
                
                line2.classList.add('opacity-0');

                line3.classList.remove('top-[35px]','left-3');
                line3.classList.add('top-[50%]', '-translate-y-[0px]', 'rotate-[45deg]', 'w-[50%]', 'left-[13px]');
            } else {
                line1.classList.remove('top-[50%]', 'translate-y-[0px]', 'rotate-[-45deg]', 'w-[50%]', 'left-[13px]');
                line1.classList.add('top-[19px]','left-3');

                line2.classList.remove('opacity-0');
                
                line3.classList.remove('top-[50%]', '-translate-y-[0px]', 'rotate-[45deg]', 'w-[50%]', 'left-[13px]');
