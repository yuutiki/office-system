    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <form method="post" action="{{route('user.store')}}" enctype="multipart/form-data">
            ...
            <div class="md:flex items-center mt-8">
                ...
                <label for="name" class="font-semibold text-gray-100 leading-none mt-4">氏名（必須）</label>
            ...
            <div class="w-full flex flex-col">
                <label for="name_kana" class="font-semibold text-gray-100 leading-none mt-4">カナ氏名（必須）</label>
            ...
            <div class="w-full flex flex-col">
                <label for="email" class="font-semibold text-gray-100 leading-none mt-4">E-MAIL（必須）</label>
            ...
            <div class="w-full flex flex-col">
                <label for="role_id" class="font-semibold text-gray-100 leading-none mt-4">権限（必須）</label>
            ...
            <div class="w-full flex flex-col">
                ...
                <input type="password" name="password" class="form-control w-auto py-2 placeholder-gray-500 border border-gray-300 rounded-md mt-1" id="password" value="{{old('password')}}">
            </div>
            @error('password')
            <div class="text-red-500">{{$message}}</div>
            @enderror
            ...
            {{-- <div class="w-full flex flex-col">
                <label for="return_at" class="font-semibold text-gray-100 leading-none mt-4">作成日（必須）</label>
