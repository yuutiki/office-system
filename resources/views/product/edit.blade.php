        ...
        <form method="post" action="{{route('product.update',$product)}}" enctype="multipart/form-data">
            ...
            <div class="grid gap-4 mb-4 sm:grid-cols-2">
                <div class="w-full flex flex-col">
                    <label for="product_code" class="font-semibold dark:text-gray-100 text-gray-900 leading-none mt-4">製品コード</label>
                    <input type="text" name="product_code" class="w-auto py-1 placeholder-gray-400 border border-gray-300 rounded-md mt-1" id="product_code" value="{{old('product_code',$product->product_code)}}" placeholder="" readonly>
                </div>
                @error('product_code')
                ...
                <div class="w-full flex flex-col">
                    ...
                    <input type="number" name="unit_price" class="w-auto py-1 placeholder-gray-400 border border-gray-300 rounded-md mt-1" id="unit_price" value="{{old('unit_price',floor($product->unit_price))}}" placeholder="1200000">
                </div>
                @error('unit_price')
                    <div class="text-red-500">{{$message}}</div>
                @enderror                   
                ...
                <div class="w-full flex flex-col">
                    ...
                    <input type="text" name="product_name" class="w-auto py-1 placeholder-gray-400 border border-gray-300 rounded-md mt-1" id="product_name" value="{{old('product_name',$product->product_name)}}" placeholder="◯◯システム">
                </div>
                @error('product_name')
                    <div class="text-red-500">{{$message}}</div>
                @enderror
                <div class="w-full flex flex-col">
                    ...
                    <input type="text" name="product_short_name" class="w-auto py-1 placeholder-gray-400 border border-gray-300 rounded-md mt-1" id="product_short_name" value="{{old('product_short_name',$product->product_short_name)}}" placeholder="">
                </div>
            ...
            <div class="w-full flex flex-col">
                ...
                <textarea name="product_memo1" class="w-auto py-1 border border-gray-300 rounded-md mt-1 placeholder-gray-400" id="product_memo1" cols="30" rows="1" placeholder="...">{{old('product_memo1',$product->product_memo1)}}</textarea>
            </div>
            @error('product_memo1')
                <div class="text-red-500">{{$message}}</div>
            @enderror
            <div class="w-full flex flex-col">
                <label for="product_memo2" class="font-semibold dark:text-gray-100 text-gray-900 leading-none mt-4">製品備考2</label>
                <textarea name="product_memo2" class="w-auto py-1 border border-gray-300 rounded-md mt-1 placeholder-gray-400" id="product_memo2" cols="30" rows="3" placeholder="...">{{old('product_memo2',$product->product_memo2)}}</textarea>
            </div>
            @error('product_memo2')
                <div class="text-red-500">{{$message}}</div>
            @enderror
