    ...
    <x-slot name="header">
        <div class="flex w-full">
            ...
            <div class="ml-auto flex  items-center space-x-2">
                <form method="post" action="{{ route('clients.store') }}" enctype="multipart/form-data" id="createForm" class="flex items-center">
                    @csrf
    ...
    <div class="max-w-7xl mx-auto px-2 pb-4 sm:pl-16">
        ...
        <div class="grid gap-4 mb-4 sm:grid-cols-2">
            <div class="">
                ...
                <input type="text" form="createForm" name="corporation_num" class="w-full py-1 placeholder-gray-400 border border-gray-300 rounded mt-1 cursor-not-allowed" id="corporation_num" value="{{ old('corporation_num') }}" placeholder="法人検索してください" readonly>
            ...
            <div class="">
                ...
                <input type="text" form="createForm" name="corporation_name" class="w-full py-1 placeholder-gray-400 border border-gray-300 rounded mt-1 cursor-not-allowed" id="corporation_name" value="{{ old('corporation_name') }}" placeholder="法人検索してください" readonly>
            ...
            <div class="">
                ...
                <input type="text" form="createForm" name="client_name" class="w-full py-1 placeholder-gray-400 border border-gray-300 rounded mt-1" id="client_name" value="{{ old('client_name') }}" placeholder="例）烏丸大学">
                @error('client_name')
                    <div class="text-red-500">{{ $message }}</div>
                @enderror
            </div>
            <div class="">
                ...
                <input type="text" form="createForm" name="client_kana_name" class="w-full py-1 placeholder-gray-400 border border-gray-300 rounded mt-1" id="client_kana_name" value="{{ old('client_kana_name') }}" placeholder="例）カラスマダイガク">
        ...
        <div class="grid gap-4 mb-4 md:grid-cols-5 grid-cols-2">
            ...
            <div>
                ...
                <select form="createForm" id="client_type_id" name="client_type_id" class="bg-gray-50 border border-gray-300 text-gray-900 rounded focus:ring-blue-500 focus:border-blue-500 block w-full p-1.5 text-sm  dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                    <option value="">未選択</option>
            ...
            <div>
                ...
                <select form="createForm" id="trade_status_id" name="trade_status_id" class="bg-gray-50 border border-gray-300 text-gray-900 rounded focus:ring-blue-500 focus:border-blue-500 block w-full p-1.5 text-sm  dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                    <option value="">未選択</option>
            ...
            <div>
                ...
                <select form="createForm" id="affiliation2" name="affiliation2" class="bg-gray-50 border border-gray-300 text-gray-900 rounded focus:ring-blue-500 focus:border-blue-500 block w-full p-1.5 text-sm     dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                    <option value="">未選択</option>
            ...
            <div>
                ...
                <select form="createForm" id="user_id" name="user_id" class="bg-gray-50 border border-gray-300 text-gray-900 rounded focus:ring-blue-500 focus:border-blue-500 block w-full p-1.5 text-sm  dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                    <option value="">未選択</option>
        ...
        <div class="hidden p-4 rounded bg-gray-50 dark:bg-gray-800" id="profile" role="tabpanel" aria-labelledby="profile-tab">
            ...
            {{-- <div class="grid gap-4 mb-4 sm:grid-cols-5 mt-2">
                ...
                <div class="w-full flex flex-col">
                    ...
                    <input type="text" form="createForm" name="tel" pattern="\d{2,4}-?\d{2,4}-?\d{3,4}" maxlength="13" id="tel" value="{{ old('tel') }}" class="w-full py-1 mt-1 placeholder-gray-400 border border-gray-300 rounded" placeholder="">
                </div>

                <div class="w-full flex flex-col">
                    <label for="fax" class="text-sm dark:text-gray-100 text-gray-900 leading-none mt-1">代表FAX（-）</label>
                    <input type="tel" form="createForm" name="fax" pattern="\d{2,4}-?\d{2,4}-?\d{3,4}" maxlength="13" id="fax" value="{{ old('fax') }}" class="w-full py-1 mt-1 placeholder-gray-400 border border-gray-300 rounded"  placeholder="">
                </div>
            </div> --}}
            ...
            <div class="grid gap-4 sm:grid-cols-2 mb-6">
                <div>
                    <div class="w-full flex flex-col">
                        <label for="tel" class="font-normal text-sm dark:text-white text-gray-900 leading-none">電話番号</label>
                        <input type="text" form="createForm" name="tel" id="tel" pattern="\d{2,4}-?\d{2,4}-?\d{3,4}" maxlength="13" onchange="validateAndFormat('tel')" value="{{ old('tel') }}" class="input-secondary" placeholder="090-1234-5678">
                    </div>
                    @error('tel')
                        <div class="text-red-500">{{$message}}</div>
                    @enderror
                ...
                <div>
                    <div class="w-full flex flex-col">
                        <label for="fax" class="font-normal text-sm dark:text-white text-gray-900 leading-none">FAX番号</label>
                        <input type="text" form="createForm" name="fax" id="fax" pattern="\d{2,4}-?\d{2,4}-?\d{3,4}" maxlength="13" onchange="validateAndFormat('fax')" value="{{ old('fax') }}" class="input-secondary" placeholder="090-1234-5678">
                    </div>
                    @error('fax')
                        <div class="text-red-500">{{$message}}</div>
                    @enderror
...
<div x-data="{ 
    ...
    {{-- フォーム送信用 --}}
    <input type="hidden" form="createForm" name="department_id" :value="selectedId">
        ...
        @endforeach
            ...
            <div class="grid gap-4 mt-1 mb-4 sm:grid-cols-5">
                ...
                <div class="w-full flex flex-col hidden">
                    ...
                    <input type="text" form="createForm" name="dealer_id" class="w-auto py-1 border border-gray-300 rounded mt-1 mb-2" id="dealer_id" value="{{ old('dealer_id') }}" placeholder="">
                </div>
                <div class="w-full flex flex-col">
                    ...
                    <div class="relative w-full">
                        <input type="text" form="createForm" name="vendor_num" class="dark:bg-gray-400 w-full py-1 border border-gray-300 rounded mt-1" id="vendor_num" value="{{ old('vendor_num') }}" disabled>
                ...
                <div class="w-full flex flex-col md:col-span-3">
                    ...
                    <input type="text" form="createForm" name="vendor_name" class="dark:bg-gray-400 w-auto py-1 border border-gray-300 rounded mt-1 mb-2" id="vendor_name" value="{{ old('vendor_name') }}" disabled>
                </div>
            </div>

            <div class="w-full flex flex-col">
                <label for="memo" class="text-sm dark:text-gray-100 text-gray-900 leading-none mt-4">備考</label>
                <textarea form="createForm" name="memo" data-auto-resize="true" class="w-auto py-1 border border-gray-300 rounded mt-1 placeholder-gray-400" id="auto-resize-textarea-client_memo" value="{{ old('memo') }}" cols="30" rows="5">{{ old('memo') }}</textarea>
            </div>
