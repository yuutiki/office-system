    ...
    <x-slot name="header">
        <div class="flex justify-between">
            <h2 class="text-xl text-gray-900 dark:text-white">
                {{ Breadcrumbs::render('createAffiliation1') }}
            </h2>
            <div class="flex justify-end items-center space-x-2">
                <x-message :message="session('message')" />

                <form method="post" action="{{ route('affiliation1.store') }}" enctype="multipart/form-data" id="affiliation1Form" class="flex items-center">
                    @csrf
        ...
        <div class="hidden md:p-4 p-2 mb-4 rounded bg-gray-50 dark:bg-gray-800" id="base" role="tabpanel" aria-labelledby="base-tab">
            ...
            <div class="grid gap-4 md:grid-cols-4 mb-4">
                <div class="w-full flex flex-col">
                    ...
                    <input type="text" form="affiliation1Form" name="affiliation1_code" class="input-secondary" id="affiliation1_code" value="{{old('affiliation1_code')}}" placeholder="" maxlength="2">
                ...
                <div class="w-full flex flex-col">
                    ...
                    <input type="text" form="affiliation1Form" name="affiliation1_prefix" class="input-secondary" id="affiliation1_prefix" value="{{old('affiliation1_prefix')}}" placeholder="" maxlength="2">
            ...
            <div class="grid gap-4 md:grid-cols-4 mb-4">
                <div class="w-full flex flex-col">
                    ...
                    <input type="text" form="affiliation1Form" name="affiliation1_name" class="input-secondary" id="affiliation1_name" value="{{old('affiliation1_name')}}" placeholder="">
                ...
                <div class="w-full flex flex-col">
                    ...
                    <input type="text" form="affiliation1Form" name="affiliation1_kana_name" class="input-secondary" id="affiliation1_kana_name" value="{{old('affiliation1_kana_name')}}" placeholder="">
                ...
                <div class="w-full flex flex-col">
                    ...
                    <input type="text" form="affiliation1Form" name="affiliation1_eng_name" class="input-secondary" id="affiliation1_eng_name" value="{{old('affiliation1_eng_name')}}" placeholder="">
                ...
                <div class="w-full flex flex-col">
                    ...
                    <input type="text" form="affiliation1Form" name="affiliation1_name_short" class="input-secondary" id="affiliation1_name_short" value="{{old('affiliation1_name_short')}}" placeholder="">
            ...
            <div class="grid gap-4 sm:grid-cols-2">
                <div class="w-full flex flex-col">
                    ...
                    <input type="text" form="affiliation1Form" name="corporation_number" class="input-primary" id="corporation_number" value="{{old('corporation_number')}}" placeholder="999999999999" maxlength="13">
                ...
                <div class="w-full flex flex-col">
                    ...
                    <input type="text" form="affiliation1Form" name="stock_code" class="input-primary" id="stock_code" value="{{old('stock_code')}}" placeholder="9999" maxlength="4">
                    @error('stock_code')
                        <div class="text-red-500">{{$message}}</div>
                    @enderror
                </div>
            ...
            <div class="grid gap-4 sm:grid-cols-2">
                <div>
                    <div class="flex">
                        <div class="w-full flex flex-col">
                            ...
                            <input type="text" form="affiliation1Form" name="invoice_num" id="invoice_num" value="{{old('invoice_num')}}" class="input-primary" placeholder="T123456789123" maxlength="14">
                        </div>
                ...
                <div>
                    <div class="w-full flex flex-col">
                        ...
                        <input type="date" min="1900-01-01" max="2200-12-31" form="affiliation1Form" name="invoice_at" id="invoice_at" value="{{old('invoice_at')}}" class="input-primary">
                    </div>
                    @error('invoice_at')
                        <div class="text-red-500">{{$message}}</div>
                    @enderror
            ...
            <div class="grid gap-4 mb-3 md:grid-cols-2 mt-4">
                <div class="md:flex items-center">
                    <div class="w-full flex flex-col">
                        ...
                        <input type="text" form="affiliation1Form" name="company_president_position_name" class="input-secondary" id="company_president_position_name" value="{{old('company_president_position_name')}}" placeholder="">
                    ...
                    <div class="w-full flex flex-col">
                        ...
                        <select name="company_president_id"form="affiliation1Form"  id="company_president_id" class="input-secondary">
                            ...
                            @foreach ($users as $user)
                                <option value="{{ $user->id }}" @selected($user->id == old('company_president_id'))>{{ $user->user_name }}</option>    
                            @endforeach
                        </select>
            ...
            <div class="grid gap-4 mb-4 sm:grid-cols-5">
                <div class="flex">
                    <div class="w-full flex flex-col">
                        ...
                        <input type="text" form="affiliation1Form" name="affiliation1_post_code" class="input-primary" id="affiliation1_post_code" value="{{old('affiliation1_post_code')}}" placeholder="">
                    </div>
                ...
                <div class="w-full flex flex-col">
                    ...
                    <select id="affiliation1_prefecture_id" form="affiliation1Form" name="affiliation1_prefecture_id" class="input-primary">
                        ...
                        @foreach($prefectures as $prefecture)
                            <option value="{{ $prefecture->id }}" @if( $prefecture->id == old('affiliation1_prefecture_id') ) selected @endif>{{ $prefecture->prefecture_code }}:{{ $prefecture->prefecture_name }}</option>
                        @endforeach
                    </select>
                </div>
                <div class="w-full flex flex-col sm:col-span-3">
                    ...
                    <input type="text" form="affiliation1Form" name="affiliation1_address1" id="affiliation1_address1" value="{{old('affiliation1_address1')}}" class="input-primary" placeholder="">
                </div>
            </div>
            ...
            <div class="grid gap-4 mb-4 md:grid-cols-2">
                <div class="w-full flex flex-col">
                    <label for="company_TEL" class="text-sm dark:text-gray-100 leading-none mt-2">代表TEL番号<span class="text-red-500"> *</span></label>
                    <input type="text" form="affiliation1Form" name="company_TEL"  onchange="validateAndFormat('company_TEL')" class="input-secondary" id="company_TEL" value="{{old('company_TEL')}}" placeholder="999-9999-9999">
                    @error('company_TEL')
                        <div class="text-red-500">{{$message}}</div>
                    @enderror
                </div>
                <div class="w-full flex flex-col">
                    <label for="company_FAX" class="text-sm dark:text-gray-100 leading-none mt-2">代表FAX番号<span class="text-red-500"> *</span></label>
                    <input type="text" form="affiliation1Form" name="company_FAX"  onchange="validateAndFormat('company_FAX')" class="input-secondary" id="company_FAX" value="{{old('company_FAX')}}" placeholder="999-9999-9999">
                    @error('company_FAX')
                        <div class="text-red-500">{{$message}}</div>
                    @enderror
                </div>
           ...
           <div class="flex">
                ...
                <div>
                    <div class="mb-8 w-20 h-20">
                        <img id="company_stamp_preview" src="{{ asset('storage/companies/company_stamp_image/default.png') }}?{{ time() }}" alt="会社印鑑" class="cursor-pointer w-full h-full object-contain rounded" onclick="document.getElementById('company_stamp_image').click()">
                ...
                <div class="ml-8">
                    <div class="mb-8 w-[165px] h-[44px] relative">
                        <img id="company_logo_preview" 
                             src="{{ asset('storage/companies/company_logo_image/logo-161.png') }}?{{ time() }}" 
                             alt="会社ロゴ" 
