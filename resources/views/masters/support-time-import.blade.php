    ...
    <div class="w-auto md:ml-14 md:mr-2 max-h-full mt-4">
        <div class="relative bg-white rounded shadow dark:bg-gray-700">
            <div class="p-4 space-y-6">
                <form action="{{ route('support-times.import') }}" method="POST" enctype="multipart/form-data" class="" id="csv_form1">
                    @csrf
                ...
                <table class="w-full text-sm text-left rtl:text-right text-gray-500 dark:text-gray-400">
                    ...
                    <tbody>
                        <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700">
                            ...
                            <td class="px-2 py-3">
                                <div class="w-[30px] text-right">2</div>
                            </td>
                            <td class="px-2 py-3">
                                ユニークキーです。
                            </td>
                        ...
                        <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700">
                            <th scope="row" class="pl-4 py-3 font-medium text-gray-900 whitespace-nowrap dark:text-white">
                                登録有効/無効<span class="text-red-500"> *</span>
                            </th>
                            <td class="px-2 py-3">
                                ◯
                            </td>
                            ...
                            <td class="px-2 py-3">
                                <div class="w-[30px] text-right">1</div>
                            </td>
                            <td class="px-2 py-3">
                                このマスタを使用してデータを登録できるかのフラグです。
                            </td>
                        </tr>
                        <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700">
                            <th scope="row" class="pl-4 py-3 font-medium text-gray-900 whitespace-nowrap dark:text-white">
                                検索有効/無効<span class="text-red-500"> *</span>
                            </th>
                            <td class="px-2 py-3">
                                ◯
                            </td>
