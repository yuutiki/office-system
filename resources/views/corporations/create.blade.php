            ...
            <div>
                <div class="grid gap-2 sm:grid-cols-5 my-2">
                    <div>
                        <div class="w-full">
                            ...
                            <input type="text" form="corporationForm" onblur="formatNumberInput(this);" name="credit_limit" id="credit_limit" value="{{ old('credit_limit') }}" class="input-primary text-right" placeholder="">
                        </div>
                        @error('credit_limit')
                            <div class="text-red-500">{{$message}}</div>
                        @enderror
                    ...
                    <div>
                        <div class="w-full">
                            ...
                            <input type="number" min="0" max="100" form="corporationForm" name="credit_rate" id="credit_rate" value="{{ old('credit_rate') }}" class="input-primary text-right" placeholder="">
                        </div>
                        @error('credit_rate')
                            <div class="text-red-500">{{$message}}</div>
                        @enderror
                    ...
                    <div class="col-span-3 mr-2">
                        <div class="w-full">
                            ...
                            <input type="text" form="corporationForm" name="credit_rater" id="credit_rater" value="{{ old('credit_rater') }}" class="input-primary" placeholder="">
                        </div>
                        @error('credit_rater')
                            <div class="text-red-500">{{$message}}</div>
                        @enderror
                ...
                <div class="mr-2 mb-4">
                    <div class="w-full flex flex-col">
                        ...
                        <input type="text" form="corporationForm" name="credit_reason" id="credit_reason" value="{{ old('credit_reason') }}" class="input-primary" placeholder="">
                    </div>
                    @error('credit_reason')
                        <div class="text-red-500">{{$message}}</div>
                    @enderror
