                ...
                <div class="grid gap-4 my-4 md:grid-cols-2">
                    <div class="md:flex items-center">
                        <div class="w-full flex flex-col">
                            ...
                            <input type="text" name="project_num" class="w-auto py-1 placeholder-gray-500 border border-gray-300 rounded mt-1" id="project_num" value="{{old('project_num',$keepfile->project_num)}}" placeholder="例）9999000100"  required>
                        </div>
                    </div>
                    <div class="w-full flex flex-col">
