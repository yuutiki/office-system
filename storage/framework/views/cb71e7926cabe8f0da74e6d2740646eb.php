      ...
      <div class="grid gap-x-4 gap-y-6 sm:grid-cols-2 md:gap-x-6 lg:grid-cols-3 xl:grid-cols-5">
        ...
        <div>
          <a target="_blank" href="https://e-timecard.systemd.co.jp:18443/WebTimeCard/Auth/Login?ReturnUrl=%2FWebTimeCard%2FHome%2FList" class="group mb-2 block h-48 overflow-hidden rounded-lg bg-gray-100 shadow-lg lg:mb-3">
            <img src="<?php echo e(asset('/assets/image/tokei.png')); ?>" loading="lazy" alt="Photo by Austin Wade" class="object-contain h-full w-full  object-center transition duration-200 group-hover:scale-110" />
          </a>
        ...
        <div>
            <a target="_blank" href="https://cybozu.systemd.co.jp/" class="group mb-2 block h-48 overflow-hidden rounded-lg bg-gray-100 shadow-lg lg:mb-3">
                <img src="<?php echo e(asset('/assets/image/cybozu.png')); ?>" loading="lazy" alt="Photo by engin akyurt" class="h-full w-full object-contain object-center transition duration-200 group-hover:scale-110" />
            </a>
        ...
        <div>
            <a target="_blank" href="https://forms.office.com/r/P5ZnLFKaGY" class="group mb-2 block h-48 overflow-hidden rounded-lg bg-gray-100 shadow-lg lg:mb-3">
                <img src="<?php echo e(asset('/assets/image/link.png')); ?>" loading="lazy" alt="Photo by Austin Wade" class="h-full w-full object-contain object-center transition duration-200 group-hover:scale-110" />
            </a>
...
<?php endif; ?><?php /**PATH C:\xampp\htdocs\laravel\officesystem\resources\views/dashboard.blade.php ENDPATH**/ ?>