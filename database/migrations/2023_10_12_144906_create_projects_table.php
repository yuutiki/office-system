...
return new class extends Migration
{
    public function up(): void
    {
        Schema::create('projects', function (Blueprint $table) {
            ...
            $table->foreignId('account_department_id')->nullable()->comment('計上部門ID'); 
            $table->foreignId('account_affiliation1_id')->nullable()->comment('計上会社ID'); 
            $table->foreignId('account_affiliation2_id')->nullable()->comment('計上事業部ID'); 
            $table->foreignId('account_affiliation3_id')->nullable()->comment('計上所属階層3ID'); 
            $table->foreignId('account_user_id')->nullable()->comment('計上担当者');
