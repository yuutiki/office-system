...
return new class extends Migration
{
    public function up(): void
    {
        Schema::create('supports', function (Blueprint $table) {
            ...
            $table->text('response_content')->nullable()->comment('回答');
            $table->text('internal_message')->nullable()->comment('社内連絡欄');
            $table->text('internal_memo1')->nullable()->comment('社内メモ欄');
            ...
            $table->string('client_user_department',20)->nullable()->comment('顧客担当者部署');
            $table->string('client_user_kana_name',20)->nullable()->comment('顧客担当者カナ氏名');
